...
public class CtDebugTarget extends org.be.textbe.ct.textct.resource.ct.debug.CtDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.be.textbe.ct.textct.resource.ct.debug.CtDebugProcess process;
	...
	private org.be.textbe.ct.textct.resource.ct.debug.CtDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener> eventListeners = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener>();
	
	private org.be.textbe.ct.textct.resource.ct.debug.CtDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public CtDebugTarget(org.be.textbe.ct.textct.resource.ct.debug.CtDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.be.textbe.ct.textct.resource.ct.debug.CtDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.be.textbe.ct.textct.resource.ct.debug.CtDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.be.textbe.ct.textct.resource.ct.debug.ICtDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.be.textbe.ct.textct.resource.ct.debug.CtLineBreakpoint lineBreakpoint = (org.be.textbe.ct.textct.resource.ct.debug.CtLineBreakpoint) breakpoint;
	...
	public void handleMessage(org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message) {
		try {
			if (message.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.STARTED)) {
				started();
			} else if (message.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.SUSPENDED)) {
				suspend();
			} else if (message.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.TERMINATED)) {
				terminated();
			} else if (message.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.RESUMED)) {
	...
	public org.be.textbe.ct.textct.resource.ct.debug.CtDebugProxy getDebugProxy() {
