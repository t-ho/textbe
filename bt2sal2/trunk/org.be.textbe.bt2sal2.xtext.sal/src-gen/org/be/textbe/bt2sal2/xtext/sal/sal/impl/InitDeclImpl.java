 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt2sal2.xtext.sal.sal.impl.InitDeclImpl#getFirstDefinitionOrCommand <em>First Definition Or Command</em>}</li>
 *   <li>{@link org.be.textbe.bt2sal2.xtext.sal.sal.impl.InitDeclImpl#getNextDefinitionOrCommand <em>Next Definition Or Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InitDeclImpl extends BaseDeclarationImpl implements InitDecl
{
  ...
  public NotificationChain basicSetFirstDefinitionOrCommand(DefinitionOrCommand newFirstDefinitionOrCommand, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SalPackage.INIT_DECL__FIRST_DEFINITION_OR_COMMAND, oldFirstDefinitionOrCommand, newFirstDefinitionOrCommand);
  ...
  public void setFirstDefinitionOrCommand(DefinitionOrCommand newFirstDefinitionOrCommand)
  {
    if (newFirstDefinitionOrCommand != firstDefinitionOrCommand)
    {
      ...
      if (firstDefinitionOrCommand != null)
        msgs = ((InternalEObject)firstDefinitionOrCommand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SalPackage.INIT_DECL__FIRST_DEFINITION_OR_COMMAND, null, msgs);
      if (newFirstDefinitionOrCommand != null)
        msgs = ((InternalEObject)newFirstDefinitionOrCommand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SalPackage.INIT_DECL__FIRST_DEFINITION_OR_COMMAND, null, msgs);
      msgs = basicSetFirstDefinitionOrCommand(newFirstDefinitionOrCommand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SalPackage.INIT_DECL__FIRST_DEFINITION_OR_COMMAND, newFirstDefinitionOrCommand, newFirstDefinitionOrCommand));
  }
  ...
  public EList<DefinitionOrCommand> getNextDefinitionOrCommand()
  {
    ...
    {
      nextDefinitionOrCommand = new EObjectContainmentEList<DefinitionOrCommand>(DefinitionOrCommand.class, this, SalPackage.INIT_DECL__NEXT_DEFINITION_OR_COMMAND);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SalPackage.INIT_DECL__FIRST_DEFINITION_OR_COMMAND:
        return basicSetFirstDefinitionOrCommand(null, msgs);
      case SalPackage.INIT_DECL__NEXT_DEFINITION_OR_COMMAND:
