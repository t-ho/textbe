...
public class BtCodeFoldingManager {
	...
	private class FoldingUpdateListener implements org.be.textbe.bt.textbt.resource.bt.IBtBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) {
				org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor = (org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) workbenchPart;
	...
	protected org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor;
	 ...
	 */
	public BtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.be.textbe.bt.textbt.resource.bt.ui.BtEditor textEditor) {
	...
	private void addCloseListener(final org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.be.textbe.bt.textbt.resource.bt.ui.BtUIPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.ui.BtUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.be.textbe.bt.textbt.resource.bt.IBtTextResource textResource = (org.be.textbe.bt.textbt.resource.bt.IBtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
