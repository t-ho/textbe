...
public class BtPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName());
	}
