...
public class BtLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.be.textbe.bt.v1.textbt.resource.bt.debug.lineBreakpoint.marker";
	
	public BtLineBreakpoint() {
		super();
	}
	
	public BtLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public String getModelIdentifier() {
		return org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtPlugin.DEBUG_MODEL_ID;
	}
	
	public void install(org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebugTarget target) {
		try {
	...
	public void remove(org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
