...
/**
 * A BtLayoutInformation is used to store layout information that is found while
 ...
 * BtLayoutInformations are aggregated in LayoutInformationAdapters. One
 * BtLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class BtLayoutInformation {
	
	private final org.be.textbe.bt.v1.textbt.resource.bt.grammar.BtSyntaxElement syntaxElement;
	...
	public BtLayoutInformation(org.be.textbe.bt.v1.textbt.resource.bt.grammar.BtSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.be.textbe.bt.v1.textbt.resource.bt.grammar.BtSyntaxElement getSyntaxElement() {
