...
public class BtExpectedTerminal {
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.IBtExpectedElement terminal;
	...
	public BtExpectedTerminal(org.be.textbe.bt.v1.textbt.resource.bt.IBtExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public org.be.textbe.bt.v1.textbt.resource.bt.IBtExpectedElement getTerminal() {
		return terminal;
	}
