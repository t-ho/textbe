...
import org.be.textbe.bt.v1.textbt.Assertion;
import org.be.textbe.bt.v1.textbt.Atomic;
import org.be.textbe.bt.v1.textbt.AttributeRealization;
import org.be.textbe.bt.v1.textbt.Behavior;
import org.be.textbe.bt.v1.textbt.BehaviorTree;
import org.be.textbe.bt.v1.textbt.Branch;
import org.be.textbe.bt.v1.textbt.Component;
import org.be.textbe.bt.v1.textbt.ComponentMarker;
import org.be.textbe.bt.v1.textbt.Event;
import org.be.textbe.bt.v1.textbt.ExternalInput;
import org.be.textbe.bt.v1.textbt.ExternalOutput;
import org.be.textbe.bt.v1.textbt.FreeTextRelation;
import org.be.textbe.bt.v1.textbt.Guard;
import org.be.textbe.bt.v1.textbt.How;
import org.be.textbe.bt.v1.textbt.Input;
import org.be.textbe.bt.v1.textbt.Interleaving;
import org.be.textbe.bt.v1.textbt.InternalInput;
import org.be.textbe.bt.v1.textbt.InternalOutput;
import org.be.textbe.bt.v1.textbt.NamedBehavior;
import org.be.textbe.bt.v1.textbt.NamedElement;
import org.be.textbe.bt.v1.textbt.Node;
import org.be.textbe.bt.v1.textbt.NodeType;
import org.be.textbe.bt.v1.textbt.Output;
...
import org.be.textbe.bt.v1.textbt.Selection;
import org.be.textbe.bt.v1.textbt.Sequence;
import org.be.textbe.bt.v1.textbt.Specification;
import org.be.textbe.bt.v1.textbt.StateRealization;
import org.be.textbe.bt.v1.textbt.SystemComponent;
import org.be.textbe.bt.v1.textbt.TextbtFactory;
...
import org.be.textbe.bt.v1.textbt.When;
...
public class TextbtPackageImpl extends EPackageImpl implements TextbtPackage
{
   ...
   * @see org.be.textbe.bt.v1.textbt.TextbtPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EReference getBehavior_Component()
  {
   ...
   * @generated
   */
  public EReference getTraceabilityLink_Node()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(behaviorEClass, BEHAVIOR__COMPONENT);
    ...
    createEReference(traceabilityLinkEClass, TRACEABILITY_LINK__NODE);
  ...
  public void initializePackageContents()
  {
    ...
    selectionEClass.getESuperTypes().add(this.getNamedBehavior());
    eventEClass.getESuperTypes().add(this.getNamedBehavior());
    guardEClass.getESuperTypes().add(this.getNamedBehavior());
    ...
    assertionEClass.getESuperTypes().add(this.getNamedBehavior());
    ...
    initEReference(getComponent_Behavior(), this.getBehavior(), this.getBehavior_Component(), "behavior", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getBehavior_Component(), this.getComponent(), this.getComponent_Behavior(), "component", null, 1, 1, Behavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNode_Traceability(), this.getTraceabilityLink(), this.getTraceabilityLink_Node(), "traceability", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTraceabilityLink_Requirement(), this.getRequirement(), null, "requirement", null, 0, -1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTraceabilityLink_Node(), this.getNode(), this.getNode_Traceability(), "node", null, 0, 1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(nodeTypeEEnum, NodeType.REFERENCE);
    ...
    addEEnumLiteral(nodeTypeEEnum, NodeType.XOR);
    addEEnumLiteral(nodeTypeEEnum, NodeType.DISJUNCTION);
    addEEnumLiteral(nodeTypeEEnum, NodeType.CONJUNCTION);
