 ...
 * a specified depth.
 */
public class BtOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public BtOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtPlugin.logError("Exception while refreshing outline view", e);
		}
	}
