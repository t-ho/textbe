...
public class BtLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtPlugin.DEBUG_MODEL_ID);
			...
			org.be.textbe.bt.v1.textbt.resource.bt.debug.BtLineBreakpoint lineBreakpoint = new org.be.textbe.bt.v1.textbt.resource.bt.debug.BtLineBreakpoint(resource, lineNumber + 1);
