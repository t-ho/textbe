 ...
 * 
 */
package org.be.textbe.bt.v1.textbt.resource.bt.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class BtLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.be.textbe.bt.v1.textbt.resource.bt.util.AbstractBtInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.be.textbe.bt.v1.textbt.resource.bt.util.AbstractBtInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebuggableInterpreter<ResultType, ContextType> interpreter = new org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebuggerListener<ResultType, ContextType> debugListener = new org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebugProcess process = new org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebugProcess(launch);
		launch.addDebugTarget(new org.be.textbe.bt.v1.textbt.resource.bt.debug.BtDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.be.textbe.bt.v1.textbt.resource.bt.launch.BtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.be.textbe.bt.v1.textbt.resource.bt.util.BtResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
