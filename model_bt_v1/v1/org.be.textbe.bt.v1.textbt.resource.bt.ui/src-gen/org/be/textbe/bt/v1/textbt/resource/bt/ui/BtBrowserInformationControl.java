 ...
 * @since 3.2
 */
public class BtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput);
		...
		fInput= (org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput) input;
		...
		org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
