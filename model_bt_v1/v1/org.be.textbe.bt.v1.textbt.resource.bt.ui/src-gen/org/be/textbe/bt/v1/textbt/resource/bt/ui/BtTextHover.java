...
public class BtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.IBtHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput infoInput = (org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHyperlink hyperlink = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl iControl = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput) {
							org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput input = (org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl.isAvailable(parent)) {
				org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl iControl = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BtTextHover(org.be.textbe.bt.v1.textbt.resource.bt.IBtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.insertPageProlog(buffer, 0, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtTextHover.getStyleSheet());
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.addPageEpilog(buffer);
			return new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.be.textbe.bt.v1.textbt.resource.bt.util.BtStreamUtil.getContent(styleSheetURL.openStream());
