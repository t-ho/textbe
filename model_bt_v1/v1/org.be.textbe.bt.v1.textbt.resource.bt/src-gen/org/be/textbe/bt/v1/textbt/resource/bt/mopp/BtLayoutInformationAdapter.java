...
/**
 * A BtLayoutInformationAdapter is used to store layout information that is found
 ...
 * BtLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class BtLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtLayoutInformation> layoutInformations = new java.util.ArrayList<org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtLayoutInformation>();
	...
	public java.util.List<org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtLayoutInformation layoutInformation) {
