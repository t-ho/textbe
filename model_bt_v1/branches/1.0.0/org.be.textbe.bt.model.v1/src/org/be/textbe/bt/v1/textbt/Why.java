 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt.v1.textbt.Why#getReason <em>Reason</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getWhy()
 * @model
 * @generated
 */
public interface Why extends FreeTextRelation
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Reason</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Reason</em>' attribute list.
   * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getWhy_Reason()
   * @model required="true"
   * @generated
   */
