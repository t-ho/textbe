 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt.v1.textbt.What#getObservation <em>Observation</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getWhat()
 * @model
 * @generated
 */
public interface What extends FreeTextRelation
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Observation</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Observation</em>' attribute list.
   * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getWhat_Observation()
   * @model required="true"
   * @generated
   */
