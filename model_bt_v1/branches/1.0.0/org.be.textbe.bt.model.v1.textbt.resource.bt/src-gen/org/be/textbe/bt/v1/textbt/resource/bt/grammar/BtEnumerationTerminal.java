 ...
 */
public class BtEnumerationTerminal extends org.be.textbe.bt.v1.textbt.resource.bt.grammar.BtTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public BtEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.be.textbe.bt.v1.textbt.resource.bt.grammar.BtCardinality cardinality, int mandatoryOccurrencesAfter) {
