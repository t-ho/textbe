 ...
 */
public class BtNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.be.textbe.bt.v1.textbt.resource.bt.ui");
							...
							String natureID = org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtNature.NATURE_ID;
							...
							for (String builderID : org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtMetaInformation info = new org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtMetaInformation();
