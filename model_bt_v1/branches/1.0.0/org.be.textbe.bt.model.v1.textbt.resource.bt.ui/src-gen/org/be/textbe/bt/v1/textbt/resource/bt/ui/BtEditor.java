...
/**
 * A text editor for 'bt' models.
 */
public class BtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.be.textbe.bt.v1.textbt.resource.bt.IBtResourceProvider, org.be.textbe.bt.v1.textbt.resource.bt.ui.IBtBracketHandlerProvider, org.be.textbe.bt.v1.textbt.resource.bt.ui.IBtAnnotationModelProvider {
	
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtCodeFoldingManager codeFoldingManager;
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBackgroundParsingStrategy bgParsingStrategy = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBackgroundParsingStrategy();
	private java.util.Collection<org.be.textbe.bt.v1.textbt.resource.bt.IBtBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.be.textbe.bt.v1.textbt.resource.bt.IBtBackgroundParsingListener>();
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtColorManager colorManager = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtColorManager();
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtOutlinePage outlinePage;
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPropertySheetPage propertySheetPage;
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.IBtBracketHandler bracketHandler;
	...
	public BtEditor() {
		super();
		setSourceViewerConfiguration(new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BtEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource currentResource = getResource();
				...
				org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.be.textbe.bt.v1.textbt.resource.bt.EditorContext");
		setRulerContextMenuId("org.be.textbe.bt.v1.textbt.resource.bt.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtNature.activate(inputFile.getProject());
		...
		org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource loadedResource = (org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource) {
					setResource((org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BtEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource textResource = (org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource) element.eResource();
			org.be.textbe.bt.v1.textbt.resource.bt.IBtLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.be.textbe.bt.v1.textbt.resource.bt.IBtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.be.textbe.bt.v1.textbt.resource.bt.IBtTextToken token = lexer.getNextToken();
			...
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BtEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.be.textbe.bt.v1.textbt.resource.bt.IBtBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.be.textbe.bt.v1.textbt.resource.bt.IBtBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.be.textbe.bt.v1.textbt.resource.bt.ui.IBtBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.be.textbe.bt.v1.textbt.resource.bt.ui.IBtBracketHandler bracketHandler) {
