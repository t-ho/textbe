...
public class BtMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.be.textbe.bt.v1.textbt.resource.bt.IBtOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtResource) {
					org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtResource customResource = (org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.be.textbe.bt.v1.textbt.resource.bt.IBtQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.be.textbe.bt.v1.textbt.resource.bt.IBtQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.be.textbe.bt.v1.textbt.resource.bt.IBtQuickFix> getQuickFixes(org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.be.textbe.bt.v1.textbt.resource.bt.IBtQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
