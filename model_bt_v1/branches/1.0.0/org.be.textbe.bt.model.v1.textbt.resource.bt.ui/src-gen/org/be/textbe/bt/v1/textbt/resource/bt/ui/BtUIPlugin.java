 ...
 */
public class BtUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.be.textbe.bt.v1.textbt.resource.bt.ui";
	public static final String EDITOR_ID = "org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEditor";
	...
	private static BtUIPlugin plugin;
	...
	public static BtUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BtUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BtUIPlugin.PLUGIN_ID, message);
		}
		final BtUIPlugin pluginInstance = BtUIPlugin.getDefault();
