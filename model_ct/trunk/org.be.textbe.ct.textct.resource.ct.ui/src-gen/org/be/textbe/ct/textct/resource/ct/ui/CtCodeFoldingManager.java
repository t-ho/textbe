 ...
 */
public class CtCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.be.textbe.ct.textct.resource.ct.ui.CtEditor) {
				org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor = (org.be.textbe.ct.textct.resource.ct.ui.CtEditor) workbenchPart;
	...
	protected org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor;
	 ...
	 */
	public CtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.be.textbe.ct.textct.resource.ct.ui.CtEditor textEditor) {
	...
	private void addCloseListener(final org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.be.textbe.ct.textct.resource.ct.ICtTextResource textResource = (org.be.textbe.ct.textct.resource.ct.ICtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
