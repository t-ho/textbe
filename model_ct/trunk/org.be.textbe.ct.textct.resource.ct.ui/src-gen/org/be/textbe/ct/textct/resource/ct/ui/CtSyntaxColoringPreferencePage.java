 ...
 */
public class CtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public CtSyntaxColoringPreferencePage() {
		super();
		
		org.be.textbe.ct.textct.resource.ct.ICtMetaInformation syntaxPlugin = new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.ct.textct.resource.ct.ui.CtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.be.textbe.ct.textct.resource.ct.ui.CtPixelConverter pixelConverter = new org.be.textbe.ct.textct.resource.ct.ui.CtPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.be.textbe.ct.textct.resource.ct.ui.CtEditor) {
			org.be.textbe.ct.textct.resource.ct.ui.CtEditor emfTextEditor = (org.be.textbe.ct.textct.resource.ct.ui.CtEditor) editor;
