 ...
 */
public class CtNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public CtNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new ct file");
