...
public class CtBracketSet {
	...
	private java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.be.textbe.ct.textct.resource.ct.ICtBracketPair {
	 ...
	 */
	private class ClosingListener implements org.be.textbe.ct.textct.resource.ct.ui.ICtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.be.textbe.ct.textct.resource.ct.ICtBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public CtBracketSet(org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtBracketPair>();
	 ...
	 */
	public org.be.textbe.ct.textct.resource.ct.ICtBracketPair getBracketPair(String opening, String closing) {
		for (org.be.textbe.ct.textct.resource.ct.ICtBracketPair bracketPair : bracketPairs) {
	...
	public org.be.textbe.ct.textct.resource.ct.ICtBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.be.textbe.ct.textct.resource.ct.ICtBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.be.textbe.ct.textct.resource.ct.ui.CtPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.be.textbe.ct.textct.resource.ct.ICtBracketPair remove(String opening, String closing) {
		for (org.be.textbe.ct.textct.resource.ct.ICtBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.be.textbe.ct.textct.resource.ct.ui.CtPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.be.textbe.ct.textct.resource.ct.ui.CtPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
