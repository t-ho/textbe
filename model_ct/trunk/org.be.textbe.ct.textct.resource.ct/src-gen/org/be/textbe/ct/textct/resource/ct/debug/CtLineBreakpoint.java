...
public class CtLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.be.textbe.ct.textct.resource.ct.debug.lineBreakpoint.marker";
	
	public CtLineBreakpoint() {
		super();
	}
	
	public CtLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.be.textbe.ct.textct.resource.ct.debug.CtDebugTarget target) {
		try {
	...
	public void remove(org.be.textbe.ct.textct.resource.ct.debug.CtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
