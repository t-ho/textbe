 ...
 * resolver
 */
public interface ICtReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.be.textbe.ct.textct.resource.ct.ICtConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.be.textbe.ct.textct.resource.ct.ICtReferenceResolveResult<ReferenceType> result);
