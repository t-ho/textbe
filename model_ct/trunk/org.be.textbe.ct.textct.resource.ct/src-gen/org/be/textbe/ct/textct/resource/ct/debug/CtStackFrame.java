...
public class CtStackFrame extends org.be.textbe.ct.textct.resource.ct.debug.CtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.be.textbe.ct.textct.resource.ct.debug.CtDebugTarget target;
	private String name;
	private int id;
	...
	public CtStackFrame(org.be.textbe.ct.textct.resource.ct.debug.CtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.be.textbe.ct.textct.resource.ct.util.CtStringUtil.decode(data, ',');
	...
	private org.be.textbe.ct.textct.resource.ct.debug.CtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.be.textbe.ct.textct.resource.ct.debug.CtStackFrame other = (org.be.textbe.ct.textct.resource.ct.debug.CtStackFrame) obj;
		if (name == null) {
