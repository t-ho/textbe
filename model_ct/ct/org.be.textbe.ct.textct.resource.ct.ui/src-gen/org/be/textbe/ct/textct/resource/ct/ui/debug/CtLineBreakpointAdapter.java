...
public class CtLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.DEBUG_MODEL_ID);
			...
			org.be.textbe.ct.textct.resource.ct.debug.CtLineBreakpoint lineBreakpoint = new org.be.textbe.ct.textct.resource.ct.debug.CtLineBreakpoint(resource, lineNumber + 1);
