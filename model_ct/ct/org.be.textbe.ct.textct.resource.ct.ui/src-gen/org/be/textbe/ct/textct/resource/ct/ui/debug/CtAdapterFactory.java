 ...
 * 
 */
package org.be.textbe.ct.textct.resource.ct.ui.debug;

@SuppressWarnings("restriction")
public class CtAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName())) {
					return new org.be.textbe.ct.textct.resource.ct.ui.debug.CtLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable) {
			final org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable variable = (org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable) {
			final org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable variable = (org.be.textbe.ct.textct.resource.ct.debug.CtDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.be.textbe.ct.textct.resource.ct.debug.CtDebugValue castedValue = (org.be.textbe.ct.textct.resource.ct.debug.CtDebugValue) value;
