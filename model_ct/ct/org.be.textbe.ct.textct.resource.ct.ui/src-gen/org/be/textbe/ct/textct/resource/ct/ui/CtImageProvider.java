 ...
 */
public class CtImageProvider {
	
	public final static CtImageProvider INSTANCE = new CtImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
