 ...
 */
public class CtNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.be.textbe.ct.textct.resource.ct.ui");
							...
							String natureID = org.be.textbe.ct.textct.resource.ct.mopp.CtNature.NATURE_ID;
							...
							for (String builderID : org.be.textbe.ct.textct.resource.ct.mopp.CtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation info = new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation();
