 ...
 * olInput</code>.
 */
public class StDocBrowserInformationControlInput {
	
	private final StDocBrowserInformationControlInput fPrevious;
	private StDocBrowserInformationControlInput fNext;
	 ...
	 */
	public StDocBrowserInformationControlInput(StDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public StDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public StDocBrowserInformationControlInput getNext() {
		return fNext;
	}
