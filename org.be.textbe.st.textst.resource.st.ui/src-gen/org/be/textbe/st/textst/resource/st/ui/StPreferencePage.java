 ...
 */
public class StPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.be.textbe.st.textst.resource.st.ui.StUIPlugin.getDefault().getPreferenceStore());
		setDescription("St Text Editor Preferences");
	}
