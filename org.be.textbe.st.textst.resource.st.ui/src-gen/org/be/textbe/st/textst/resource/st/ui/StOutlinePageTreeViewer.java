 ...
 * a specified depth.
 */
public class StOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public StOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.be.textbe.st.textst.resource.st.ui.StEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.be.textbe.st.textst.resource.st.mopp.StPlugin.logError("Exception while refreshing outline view", e);
		}
	}
