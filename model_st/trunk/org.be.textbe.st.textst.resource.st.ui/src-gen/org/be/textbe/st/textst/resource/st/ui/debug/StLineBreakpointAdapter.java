...
public class StLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.be.textbe.st.textst.resource.st.mopp.StPlugin.DEBUG_MODEL_ID);
			...
			org.be.textbe.st.textst.resource.st.debug.StLineBreakpoint lineBreakpoint = new org.be.textbe.st.textst.resource.st.debug.StLineBreakpoint(resource, lineNumber + 1);
