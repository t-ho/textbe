 ...
 * instance of StDefaultTokenResolver which performs a standard conversion based
 * on the EMF type conversion. This includes conversion of registered EDataTypes.
 * 
 * @see org.be.textbe.st.textst.resource.st.analysis.StDefaultTokenResolver
 */
public interface IStTokenResolver extends org.be.textbe.st.textst.resource.st.IStConfigurable {
