 ...
 */
public class StHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public StHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.be.textbe.st.textst.resource.st.mopp.StPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
