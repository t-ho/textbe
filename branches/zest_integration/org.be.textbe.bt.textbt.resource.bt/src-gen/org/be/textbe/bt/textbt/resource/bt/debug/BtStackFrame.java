...
public class BtStackFrame extends org.be.textbe.bt.textbt.resource.bt.debug.BtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget target;
	private String name;
	private int id;
	...
	public BtStackFrame(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.be.textbe.bt.textbt.resource.bt.util.BtStringUtil.decode(data, ',');
	...
	private org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.be.textbe.bt.textbt.resource.bt.debug.BtStackFrame other = (org.be.textbe.bt.textbt.resource.bt.debug.BtStackFrame) obj;
		if (name == null) {
