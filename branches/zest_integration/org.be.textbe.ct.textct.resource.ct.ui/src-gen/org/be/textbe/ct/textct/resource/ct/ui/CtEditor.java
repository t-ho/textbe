...
/**
 * A text editor for 'ct' models.
 */
public class CtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.be.textbe.ct.textct.resource.ct.ICtResourceProvider, org.be.textbe.ct.textct.resource.ct.ui.ICtBracketHandlerProvider, org.be.textbe.ct.textct.resource.ct.ui.ICtAnnotationModelProvider {
	
	private org.be.textbe.ct.textct.resource.ct.ui.CtHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.be.textbe.ct.textct.resource.ct.ui.CtCodeFoldingManager codeFoldingManager;
	private org.be.textbe.ct.textct.resource.ct.ui.CtBackgroundParsingStrategy bgParsingStrategy = new org.be.textbe.ct.textct.resource.ct.ui.CtBackgroundParsingStrategy();
	private java.util.Collection<org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener>();
	private org.be.textbe.ct.textct.resource.ct.ui.CtColorManager colorManager = new org.be.textbe.ct.textct.resource.ct.ui.CtColorManager();
	private org.be.textbe.ct.textct.resource.ct.ui.CtOutlinePage outlinePage;
	...
	private org.be.textbe.ct.textct.resource.ct.ui.CtPropertySheetPage propertySheetPage;
	...
	private org.be.textbe.ct.textct.resource.ct.ui.ICtBracketHandler bracketHandler;
	...
	public CtEditor() {
		super();
		setSourceViewerConfiguration(new org.be.textbe.ct.textct.resource.ct.ui.CtEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), CtEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.be.textbe.ct.textct.resource.ct.ICtTextResource currentResource = getResource();
				...
				org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.be.textbe.ct.textct.resource.ct.EditorContext");
		setRulerContextMenuId("org.be.textbe.ct.textct.resource.ct.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.be.textbe.ct.textct.resource.ct.ui.CtHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.be.textbe.ct.textct.resource.ct.ui.CtCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.be.textbe.ct.textct.resource.ct.mopp.CtNature.activate(inputFile.getProject());
		...
		org.be.textbe.ct.textct.resource.ct.ICtTextResource loadedResource = (org.be.textbe.ct.textct.resource.ct.ICtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.be.textbe.ct.textct.resource.ct.ICtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.be.textbe.ct.textct.resource.ct.ICtTextResource) {
					setResource((org.be.textbe.ct.textct.resource.ct.ICtTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the CtEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.be.textbe.ct.textct.resource.ct.ICtTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.be.textbe.ct.textct.resource.ct.ui.CtOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.be.textbe.ct.textct.resource.ct.ui.CtPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.be.textbe.ct.textct.resource.ct.ICtTextResource textResource = (org.be.textbe.ct.textct.resource.ct.ICtTextResource) element.eResource();
			...
			org.be.textbe.ct.textct.resource.ct.ICtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.be.textbe.ct.textct.resource.ct.ICtTextToken token = lexer.getNextToken();
			...
			org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!CtEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.be.textbe.ct.textct.resource.ct.ui.ICtBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.be.textbe.ct.textct.resource.ct.ui.ICtBracketHandler bracketHandler) {
