 ...
 */
public class CtCompletionProposal implements java.lang.Comparable<CtCompletionProposal> {
	...
	public CtCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public CtCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public CtCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof CtCompletionProposal) {
			CtCompletionProposal other = (CtCompletionProposal) object;
	...
	public int compareTo(CtCompletionProposal object) {
		if (object instanceof CtCompletionProposal) {
			CtCompletionProposal other = (CtCompletionProposal) object;
