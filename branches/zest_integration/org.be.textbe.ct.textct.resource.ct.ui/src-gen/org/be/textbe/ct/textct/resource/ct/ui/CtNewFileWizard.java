...
public class CtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.be.textbe.ct.textct.resource.ct.ui.CtNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public CtNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.be.textbe.ct.textct.resource.ct.ui.CtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getSyntaxName();
	}
