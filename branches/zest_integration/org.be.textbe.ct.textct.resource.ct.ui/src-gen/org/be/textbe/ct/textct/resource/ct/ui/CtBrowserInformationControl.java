 ...
 * @since 3.2
 */
public class CtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput);
		...
		fInput= (org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput) input;
		...
		org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
