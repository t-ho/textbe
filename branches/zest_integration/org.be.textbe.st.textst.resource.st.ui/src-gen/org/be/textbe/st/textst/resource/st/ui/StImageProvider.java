...
public class StImageProvider {
	...
	public final static StImageProvider INSTANCE = new StImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.be.textbe.st.textst.resource.st.ui.StUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.be.textbe.st.textst.resource.st.ui.StUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
