...
public class StTextToken implements org.be.textbe.st.textst.resource.st.IStTextToken {
	
	private final org.be.textbe.st.textst.resource.st.IStMetaInformation metaInformation = new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public StTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
