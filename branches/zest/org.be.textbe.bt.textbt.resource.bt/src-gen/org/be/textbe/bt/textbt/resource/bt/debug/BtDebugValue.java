...
public class BtDebugValue extends org.be.textbe.bt.textbt.resource.bt.debug.BtDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BtDebugValue(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
