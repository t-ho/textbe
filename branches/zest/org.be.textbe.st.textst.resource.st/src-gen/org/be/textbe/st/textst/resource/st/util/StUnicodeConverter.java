 ...
 * to 4 bytes).
 */
public class StUnicodeConverter extends org.be.textbe.st.textst.resource.st.mopp.StInputStreamProcessor {
	 ...
	 */
	public StUnicodeConverter(java.io.InputStream inputStream) {
