 ...
 */
public class CtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.be.textbe.ct.textct.resource.ct.ICtHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput infoInput = (org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.be.textbe.ct.textct.resource.ct.ui.CtHyperlink hyperlink = new org.be.textbe.ct.textct.resource.ct.ui.CtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl iControl = new org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput) {
							org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput input = (org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl.isAvailable(parent)) {
				org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl iControl = new org.be.textbe.ct.textct.resource.ct.ui.CtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public CtTextHover(org.be.textbe.ct.textct.resource.ct.ICtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.be.textbe.ct.textct.resource.ct.ui.CtUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.be.textbe.ct.textct.resource.ct.ICtTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.insertPageProlog(buffer, 0, org.be.textbe.ct.textct.resource.ct.ui.CtTextHover.getStyleSheet());
			org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.addPageEpilog(buffer);
			return new org.be.textbe.ct.textct.resource.ct.ui.CtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.be.textbe.ct.textct.resource.ct.ui.CtHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.be.textbe.ct.textct.resource.ct.util.CtStreamUtil.getContent(styleSheetURL.openStream());
