...
public class StPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getSyntaxName());
	}
