 ...
 */
public class StSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public StSyntaxColoringPreferencePage() {
		super();
		
		org.be.textbe.st.textst.resource.st.IStMetaInformation syntaxPlugin = new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.st.textst.resource.st.ui.StSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.be.textbe.st.textst.resource.st.ui.StPixelConverter pixelConverter = new org.be.textbe.st.textst.resource.st.ui.StPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.be.textbe.st.textst.resource.st.ui.StEditor) {
			org.be.textbe.st.textst.resource.st.ui.StEditor emfTextEditor = (org.be.textbe.st.textst.resource.st.ui.StEditor) editor;
