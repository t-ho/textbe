 ...
 */
public class StOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.be.textbe.st.textst.resource.st.ui.outlinecontext";
	...
	public StOutlinePage(org.be.textbe.st.textst.resource.st.ui.StEditor textEditor) {
		super();
		this.editor = textEditor;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.be.textbe.st.textst.resource.st.ui.StOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.be.textbe.st.textst.resource.st.ui.outlinecontext", menuManager, treeViewer);
	}
