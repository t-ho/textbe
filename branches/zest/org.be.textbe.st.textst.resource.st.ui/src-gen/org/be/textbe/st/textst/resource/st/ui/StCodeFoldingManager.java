 ...
 */
public class StCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.be.textbe.st.textst.resource.st.IStBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.be.textbe.st.textst.resource.st.ui.StEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.be.textbe.st.textst.resource.st.ui.StEditor) {
				org.be.textbe.st.textst.resource.st.ui.StEditor editor = (org.be.textbe.st.textst.resource.st.ui.StEditor) workbenchPart;
	...
	protected org.be.textbe.st.textst.resource.st.ui.StEditor editor;
	 ...
	 */
	public StCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.be.textbe.st.textst.resource.st.ui.StEditor textEditor) {
	...
	private void addCloseListener(final org.be.textbe.st.textst.resource.st.ui.StEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.be.textbe.st.textst.resource.st.ui.StUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.be.textbe.st.textst.resource.st.IStTextResource textResource = (org.be.textbe.st.textst.resource.st.IStTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
