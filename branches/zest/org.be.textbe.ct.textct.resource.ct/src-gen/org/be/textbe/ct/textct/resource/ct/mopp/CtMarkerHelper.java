 ...
 * contains <code>org.be.textbe.ct.textct.resource.ct.ICtTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class CtMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.be.textbe.ct.textct.resource.ct.ICtCommand<Object>> commands = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.be.textbe.ct.textct.resource.ct.ICtCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.be.textbe.ct.textct.resource.ct.ICtCommand<Object>> commandsToProcess = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.ICtCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.be.textbe.ct.textct.resource.ct.ICtCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.be.textbe.ct.textct.resource.ct.ICtTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.be.textbe.ct.textct.resource.ct.ICtTextDiagnostic diagnostic) {
		final org.be.textbe.ct.textct.resource.ct.ICtProblem problem = diagnostic.getProblem();
		org.be.textbe.ct.textct.resource.ct.CtEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.be.textbe.ct.textct.resource.ct.ICtCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.be.textbe.ct.textct.resource.ct.CtEProblemSeverity.ERROR) {
					...
					org.be.textbe.ct.textct.resource.ct.ICtTextDiagnostic textDiagnostic = (org.be.textbe.ct.textct.resource.ct.ICtTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.be.textbe.ct.textct.resource.ct.mopp.CtResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.be.textbe.ct.textct.resource.ct.mopp.CtResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.be.textbe.ct.textct.resource.ct.ICtQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.be.textbe.ct.textct.resource.ct.util.CtStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.be.textbe.ct.textct.resource.ct.CtEProblemType nextType : org.be.textbe.ct.textct.resource.ct.CtEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.be.textbe.ct.textct.resource.ct.CtEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.be.textbe.ct.textct.resource.ct.CtEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.be.textbe.ct.textct.resource.ct.CtEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
