...
public class BtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	 ...
	 */
	public BtTextHover(org.be.textbe.bt.textbt.resource.bt.IBtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.be.textbe.bt.textbt.resource.bt.ui.BtUIMetaInformation().getHoverTextProvider();
	}
	...
	private org.be.textbe.bt.textbt.resource.bt.ui.BtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.be.textbe.bt.textbt.resource.bt.ui.BtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.be.textbe.bt.textbt.resource.bt.ui.BtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
		...
		if (buffer.length() > 0) {
			...
			return new org.be.textbe.bt.textbt.resource.bt.ui.BtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String loadStyleSheet() {
		...
		if (styleSheetURL != null) {
			try {
				return org.be.textbe.bt.textbt.resource.bt.util.BtStreamUtil.getContent(styleSheetURL.openStream());
