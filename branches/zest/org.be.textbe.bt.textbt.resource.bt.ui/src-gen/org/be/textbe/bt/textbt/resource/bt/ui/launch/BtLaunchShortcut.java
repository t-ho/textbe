 ...
 */
public class BtLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.be.textbe.bt.textbt.resource.bt.launch.BtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Exception while launching selection", e);
		}
	}
