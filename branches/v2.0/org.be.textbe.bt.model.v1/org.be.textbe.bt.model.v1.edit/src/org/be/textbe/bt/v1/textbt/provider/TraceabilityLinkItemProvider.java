...
/**
 * This is the item provider adapter for a {@link org.be.textbe.bt.v1.textbt.TraceabilityLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceabilityLinkItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceabilityLink_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceabilityLink_status_feature", "_UI_TraceabilityLink_type"),
				 TextbtPackage.Literals.TRACEABILITY_LINK__STATUS,
				 true,
				 false,
				 false,
	...
	protected void addRequirementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceabilityLink_requirement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceabilityLink_requirement_feature", "_UI_TraceabilityLink_type"),
				 TextbtPackage.Literals.TRACEABILITY_LINK__REQUIREMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		TraceabilityStatus labelValue = ((TraceabilityLink)object).getStatus();
