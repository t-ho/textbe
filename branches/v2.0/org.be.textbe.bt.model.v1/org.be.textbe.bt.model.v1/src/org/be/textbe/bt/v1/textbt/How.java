 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt.v1.textbt.How#getMeans <em>Means</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getHow()
 * @model
 * @generated
 */
public interface How extends FreeTextRelation
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Means</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Means</em>' attribute list.
   * @see org.be.textbe.bt.v1.textbt.TextbtPackage#getHow_Means()
   * @model required="true"
   * @generated
   */
