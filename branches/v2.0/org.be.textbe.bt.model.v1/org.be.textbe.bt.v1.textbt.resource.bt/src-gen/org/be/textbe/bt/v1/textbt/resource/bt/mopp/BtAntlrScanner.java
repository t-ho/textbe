...
public class BtAntlrScanner implements org.be.textbe.bt.v1.textbt.resource.bt.IBtTextScanner {
	...
	public org.be.textbe.bt.v1.textbt.resource.bt.IBtTextToken getNextToken() {
		...
		org.be.textbe.bt.v1.textbt.resource.bt.IBtTextToken result = new org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtTextToken(current);
		return result;
	}
