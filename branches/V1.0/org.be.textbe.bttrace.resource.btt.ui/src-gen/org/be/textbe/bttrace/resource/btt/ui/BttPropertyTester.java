...
public class BttPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getSyntaxName());
	}
