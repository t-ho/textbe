 ...
 */
public class BtNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BtNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new bt file");
