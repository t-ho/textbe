 ...
 */
public class StBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.be.textbe.st.textst.resource.st.IStTextResource resource, final org.be.textbe.st.textst.resource.st.ui.StEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.be.textbe.st.textst.resource.st.IStTextResource resource, final org.be.textbe.st.textst.resource.st.ui.StEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.be.textbe.st.textst.resource.st.IStTextResource resource, final org.be.textbe.st.textst.resource.st.ui.StEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
