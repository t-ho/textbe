 ...
 * conversion.
 */
public interface IStInputStreamProcessorProvider {
	 ...
	 */
	public org.be.textbe.st.textst.resource.st.mopp.StInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
