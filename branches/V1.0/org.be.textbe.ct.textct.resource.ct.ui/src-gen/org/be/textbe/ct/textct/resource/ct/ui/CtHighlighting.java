 ...
 */
public class CtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.be.textbe.ct.textct.resource.ct.ui.CtPositionHelper positionHelper = new org.be.textbe.ct.textct.resource.ct.ui.CtPositionHelper();
	...
	private org.be.textbe.ct.textct.resource.ct.ui.CtTokenScanner scanner;
	...
	private org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.be.textbe.ct.textct.resource.ct.ui.CtOccurrence occurrence;
	private org.be.textbe.ct.textct.resource.ct.ui.CtBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.be.textbe.ct.textct.resource.ct.ICtBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public CtHighlighting(org.be.textbe.ct.textct.resource.ct.ICtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.be.textbe.ct.textct.resource.ct.ui.CtColorManager colorManager, org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.be.textbe.ct.textct.resource.ct.ui.CtTokenScanner(textResource, colorManager);
		occurrence = new org.be.textbe.ct.textct.resource.ct.ui.CtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.be.textbe.ct.textct.resource.ct.ui.CtBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.be.textbe.ct.textct.resource.ct.ui.CtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.ct.textct.resource.ct.ui.CtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.be.textbe.ct.textct.resource.ct.ui.CtEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.be.textbe.ct.textct.resource.ct.ui.CtPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.be.textbe.ct.textct.resource.ct.ui.CtPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.be.textbe.ct.textct.resource.ct.ui.CtPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.be.textbe.ct.textct.resource.ct.ui.CtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
