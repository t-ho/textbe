...
public class CtNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.be.textbe.ct.textct.resource.ct.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.be.textbe.ct.textct.resource.ct.mopp.CtBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.be.textbe.ct.textct.resource.ct.mopp.CtBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
