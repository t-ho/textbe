 ...
 */
public class CtExpectedTerminal {
	
	private int followSetID;
	private org.be.textbe.ct.textct.resource.ct.ICtExpectedElement terminal;
	...
	public CtExpectedTerminal(org.be.textbe.ct.textct.resource.ct.ICtExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public org.be.textbe.ct.textct.resource.ct.ICtExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((CtExpectedTerminal) o).terminal);
	}
