 ...
 * @generated
 */
public class SystemStateGuardSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SystemStateGuardPackage.SYSTEM_STATE_GUARD: {
				SystemStateGuard systemStateGuard = (SystemStateGuard)theEObject;
				T result = caseSystemStateGuard(systemStateGuard);
				if (result == null) result = caseActivity(systemStateGuard);
				if (result == null) result = caseBehaviorTree(systemStateGuard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemStateGuardPackage.CONJUNCTION: {
				Conjunction conjunction = (Conjunction)theEObject;
				T result = caseConjunction(conjunction);
				if (result == null) result = caseSystemStateGuard(conjunction);
				if (result == null) result = caseActivity(conjunction);
				if (result == null) result = caseBehaviorTree(conjunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemStateGuardPackage.DISJUNCTION: {
				Disjunction disjunction = (Disjunction)theEObject;
				T result = caseDisjunction(disjunction);
				if (result == null) result = caseSystemStateGuard(disjunction);
				if (result == null) result = caseActivity(disjunction);
				if (result == null) result = caseBehaviorTree(disjunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemStateGuardPackage.MUTUAL_EXCLUSION: {
				MutualExclusion mutualExclusion = (MutualExclusion)theEObject;
				T result = caseMutualExclusion(mutualExclusion);
				if (result == null) result = caseSystemStateGuard(mutualExclusion);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>System State Guard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>System State Guard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSystemStateGuard(SystemStateGuard object) {
		return null;
	}
