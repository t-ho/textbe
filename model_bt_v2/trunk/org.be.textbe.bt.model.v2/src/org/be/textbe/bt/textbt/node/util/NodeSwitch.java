/**
 */
package org.be.textbe.bt.textbt.node.util;
...
public class NodeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NodePackage.BEHAVIOR_NODE: {
				BehaviorNode behaviorNode = (BehaviorNode)theEObject;
				T result = caseBehaviorNode(behaviorNode);
				if (result == null) result = caseOperationNode(behaviorNode);
				if (result == null) result = caseNode(behaviorNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodePackage.LABEL_ONLY_NODE: {
				LabelOnlyNode labelOnlyNode = (LabelOnlyNode)theEObject;
				T result = caseLabelOnlyNode(labelOnlyNode);
				if (result == null) result = caseOperationNode(labelOnlyNode);
				if (result == null) result = caseNode(labelOnlyNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodePackage.OPERATION_NODE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Label Only Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Label Only Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLabelOnlyNode(LabelOnlyNode object) {
		return null;
	}
