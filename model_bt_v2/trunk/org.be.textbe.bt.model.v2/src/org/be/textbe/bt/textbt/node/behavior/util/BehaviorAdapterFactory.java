 ...
 * $Id$
 */
package org.be.textbe.bt.textbt.node.behavior.util;
...
public class BehaviorAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.node.behavior.BehaviorNode <em>Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
