...
public class TextbtPackageImpl extends EPackageImpl implements TextbtPackage {
	 ...
	 * @generated
	 */
	public EReference getSpecification_ComponentTypes() {
	...
	public void createPackageContents() {
		...
		createEReference(specificationEClass, SPECIFICATION__COMPONENT_TYPES);
	...
	public void initializePackageContents() {
		...
		initEReference(getSpecification_ComponentTypes(), theComponentPackage.getComponentType(), null, "componentTypes", null, 1, -1, Specification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getBehaviorTree_Subtrees(), 
		   source, 
		   new String[] {
			 "derivation", "OrderedSet{}"
		   });		
	}
