...
public class SequenceAdapterFactory extends AdapterFactoryImpl {
	...
	protected SequenceSwitch<Adapter> modelSwitch =
		new SequenceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInterleavingSequence(InterleavingSequence object) {
				return createInterleavingSequenceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.activity.sequence.AtomicSequence <em>Atomic Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.activity.sequence.InterleavingSequence <em>Interleaving Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInterleavingSequenceAdapter() {
		return null;
	}
