...
public class NodeAdapterFactory extends AdapterFactoryImpl {
	...
	protected NodeSwitch<Adapter> modelSwitch =
		new NodeSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLabelOnlyNode(LabelOnlyNode object) {
				return createLabelOnlyNodeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.node.BehaviorNode <em>Behavior Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.node.LabelOnlyNode <em>Label Only Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLabelOnlyNodeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.node.OperationNode <em>Operation Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
