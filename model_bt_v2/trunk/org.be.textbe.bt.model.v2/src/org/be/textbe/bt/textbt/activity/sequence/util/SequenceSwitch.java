...
public class SequenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SequencePackage.ATOMIC_SEQUENCE: {
				AtomicSequence atomicSequence = (AtomicSequence)theEObject;
				T result = caseAtomicSequence(atomicSequence);
				if (result == null) result = caseSequence(atomicSequence);
				if (result == null) result = caseActivity(atomicSequence);
				if (result == null) result = caseBehaviorTree(atomicSequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequencePackage.INTERLEAVING_SEQUENCE: {
				InterleavingSequence interleavingSequence = (InterleavingSequence)theEObject;
				T result = caseInterleavingSequence(interleavingSequence);
				if (result == null) result = caseSequence(interleavingSequence);
				if (result == null) result = caseActivity(interleavingSequence);
				if (result == null) result = caseBehaviorTree(interleavingSequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Interleaving Sequence</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Interleaving Sequence</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterleavingSequence(InterleavingSequence object) {
		return null;
	}
