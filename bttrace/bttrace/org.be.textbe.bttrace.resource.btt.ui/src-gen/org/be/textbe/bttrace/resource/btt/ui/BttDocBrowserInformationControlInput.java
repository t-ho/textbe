 ...
 * olInput</code>.
 */
public class BttDocBrowserInformationControlInput {
	
	private final BttDocBrowserInformationControlInput fPrevious;
	private BttDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BttDocBrowserInformationControlInput(BttDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BttDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BttDocBrowserInformationControlInput getNext() {
		return fNext;
	}
