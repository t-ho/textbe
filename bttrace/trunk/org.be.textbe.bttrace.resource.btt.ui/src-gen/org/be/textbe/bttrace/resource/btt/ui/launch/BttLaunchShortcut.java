 ...
 */
public class BttLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.be.textbe.bttrace.resource.btt.launch.BttLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.be.textbe.bttrace.resource.btt.mopp.BttPlugin.logError("Exception while launching selection", e);
		}
	}
