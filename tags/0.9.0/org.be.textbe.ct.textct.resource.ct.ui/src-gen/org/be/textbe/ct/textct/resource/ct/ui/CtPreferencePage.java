 ...
 */
public class CtPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.getDefault().getPreferenceStore());
		setDescription("Ct Text Editor Preferences");
	}
