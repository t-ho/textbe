...
public class CtMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.be.textbe.ct.textct.resource.ct.ICtOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.be.textbe.ct.textct.resource.ct.mopp.CtResource) {
					org.be.textbe.ct.textct.resource.ct.mopp.CtResource customResource = (org.be.textbe.ct.textct.resource.ct.mopp.CtResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.be.textbe.ct.textct.resource.ct.ICtQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.be.textbe.ct.textct.resource.ct.ICtQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.be.textbe.ct.textct.resource.ct.ui.CtUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.be.textbe.ct.textct.resource.ct.ICtQuickFix> getQuickFixes(org.be.textbe.ct.textct.resource.ct.ICtTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.be.textbe.ct.textct.resource.ct.ICtQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
