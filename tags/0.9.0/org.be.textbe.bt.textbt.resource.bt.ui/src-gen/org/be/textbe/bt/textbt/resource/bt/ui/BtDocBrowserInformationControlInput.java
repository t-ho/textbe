 ...
 * olInput</code>.
 */
public class BtDocBrowserInformationControlInput {
	
	private final BtDocBrowserInformationControlInput fPrevious;
	private BtDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BtDocBrowserInformationControlInput(BtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
