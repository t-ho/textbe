 ...
 * @since 3.2
 */
public class StBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput fInput;
	 ...
	 */
	public StBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public StBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public StBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput);
		...
		fInput= (org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput) input;
		...
		org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput getInput() {
		return fInput;
	}
