 ...
 * contains <code>org.be.textbe.bt.textbt.resource.bt.IBtTextDiagnostic</code>s it
...
public class BtMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object>> commands = new java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object>> commandsToProcess = new java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.be.textbe.bt.textbt.resource.bt.IBtTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.be.textbe.bt.textbt.resource.bt.IBtTextDiagnostic diagnostic) {
		final org.be.textbe.bt.textbt.resource.bt.IBtProblem problem = diagnostic.getProblem();
		org.be.textbe.bt.textbt.resource.bt.BtEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.be.textbe.bt.textbt.resource.bt.IBtCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.be.textbe.bt.textbt.resource.bt.BtEProblemSeverity.ERROR) {
					...
					org.be.textbe.bt.textbt.resource.bt.IBtTextDiagnostic textDiagnostic = (org.be.textbe.bt.textbt.resource.bt.IBtTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.be.textbe.bt.textbt.resource.bt.mopp.BtResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.be.textbe.bt.textbt.resource.bt.mopp.BtResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.be.textbe.bt.textbt.resource.bt.IBtQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.be.textbe.bt.textbt.resource.bt.util.BtStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.be.textbe.bt.textbt.resource.bt.BtEProblemType nextType : org.be.textbe.bt.textbt.resource.bt.BtEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.be.textbe.bt.textbt.resource.bt.BtEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.be.textbe.bt.textbt.resource.bt.BtEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.be.textbe.bt.textbt.resource.bt.BtEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
