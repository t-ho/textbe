...
public abstract class BtQuickFix implements org.be.textbe.bt.textbt.resource.bt.IBtQuickFix {
	...
	public String apply(String currentText) {
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Exception while applying quick fix", e);
		}
		return null;
	}
