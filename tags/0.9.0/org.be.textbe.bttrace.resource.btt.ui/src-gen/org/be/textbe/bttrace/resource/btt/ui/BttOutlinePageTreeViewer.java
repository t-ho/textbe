 ...
 * a specified depth.
 */
public class BttOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public BttOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.be.textbe.bttrace.resource.btt.ui.BttEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.be.textbe.bttrace.resource.btt.mopp.BttPlugin.logError("Exception while refreshing outline view", e);
		}
	}
