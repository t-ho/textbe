 ...
 */
public class BttHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public BttHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.be.textbe.bttrace.resource.btt.mopp.BttPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
