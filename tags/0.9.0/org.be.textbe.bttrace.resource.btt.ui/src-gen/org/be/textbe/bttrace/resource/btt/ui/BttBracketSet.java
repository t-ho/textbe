...
public class BttBracketSet {
	...
	private java.util.ArrayList<org.be.textbe.bttrace.resource.btt.IBttBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.be.textbe.bttrace.resource.btt.IBttBracketPair {
	 ...
	 */
	private class ClosingListener implements org.be.textbe.bttrace.resource.btt.ui.IBttBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.be.textbe.bttrace.resource.btt.IBttBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public BttBracketSet(org.be.textbe.bttrace.resource.btt.ui.BttEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.be.textbe.bttrace.resource.btt.IBttBracketPair>();
	 ...
	 */
	public org.be.textbe.bttrace.resource.btt.IBttBracketPair getBracketPair(String opening, String closing) {
		for (org.be.textbe.bttrace.resource.btt.IBttBracketPair bracketPair : bracketPairs) {
	...
	public org.be.textbe.bttrace.resource.btt.IBttBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.be.textbe.bttrace.resource.btt.IBttBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.be.textbe.bttrace.resource.btt.ui.BttPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.be.textbe.bttrace.resource.btt.IBttBracketPair remove(String opening, String closing) {
		for (org.be.textbe.bttrace.resource.btt.IBttBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.be.textbe.bttrace.resource.btt.IBttBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.be.textbe.bttrace.resource.btt.ui.BttPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.be.textbe.bttrace.resource.btt.ui.BttPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
