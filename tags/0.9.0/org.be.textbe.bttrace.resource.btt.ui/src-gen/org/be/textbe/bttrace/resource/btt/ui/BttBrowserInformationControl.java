 ...
 * @since 3.2
 */
public class BttBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BttBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BttBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BttBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput);
		...
		fInput= (org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput) input;
		...
		org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput getInput() {
		return fInput;
	}
