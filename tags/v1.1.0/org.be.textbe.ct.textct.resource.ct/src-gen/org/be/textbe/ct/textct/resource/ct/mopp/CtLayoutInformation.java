...
/**
 * A CtLayoutInformation is used to store layout information that is found while
 ...
 * CtLayoutInformations are aggregated in LayoutInformationAdapters. One
 * CtLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class CtLayoutInformation {
	
	private final org.be.textbe.ct.textct.resource.ct.grammar.CtSyntaxElement syntaxElement;
	...
	public CtLayoutInformation(org.be.textbe.ct.textct.resource.ct.grammar.CtSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.be.textbe.ct.textct.resource.ct.grammar.CtSyntaxElement getSyntaxElement() {
