...
public class StStackFrame extends org.be.textbe.st.textst.resource.st.debug.StDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.be.textbe.st.textst.resource.st.debug.StDebugTarget target;
	private String name;
	private int id;
	...
	public StStackFrame(org.be.textbe.st.textst.resource.st.debug.StDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.be.textbe.st.textst.resource.st.util.StStringUtil.decode(data, ',');
	...
	private org.be.textbe.st.textst.resource.st.debug.StDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.be.textbe.st.textst.resource.st.debug.StStackFrame other = (org.be.textbe.st.textst.resource.st.debug.StStackFrame) obj;
		if (name == null) {
