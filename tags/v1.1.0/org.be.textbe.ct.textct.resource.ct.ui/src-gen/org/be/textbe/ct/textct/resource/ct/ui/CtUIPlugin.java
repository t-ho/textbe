 ...
 */
public class CtUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.be.textbe.ct.textct.resource.ct.ui";
	public static final String EDITOR_ID = "org.be.textbe.ct.textct.resource.ct.ui.CtEditor";
	...
	private static CtUIPlugin plugin;
	...
	public static CtUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CtUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, CtUIPlugin.PLUGIN_ID, message);
		}
		final CtUIPlugin pluginInstance = CtUIPlugin.getDefault();
