 ...
 */
public class CtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public CtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
