 ...
 */
public class CtLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.be.textbe.ct.textct.resource.ct.mopp.CtMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.be.textbe.ct.textct.resource.ct.launch.CtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.logError("Exception while launching selection", e);
		}
	}
