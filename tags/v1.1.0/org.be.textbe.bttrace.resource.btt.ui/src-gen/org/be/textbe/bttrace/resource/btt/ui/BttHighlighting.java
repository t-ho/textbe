 ...
 */
public class BttHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.be.textbe.bttrace.resource.btt.ui.BttPositionHelper positionHelper = new org.be.textbe.bttrace.resource.btt.ui.BttPositionHelper();
	...
	private org.be.textbe.bttrace.resource.btt.ui.BttTokenScanner scanner;
	...
	private org.be.textbe.bttrace.resource.btt.ui.BttEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.be.textbe.bttrace.resource.btt.ui.BttOccurrence occurrence;
	private org.be.textbe.bttrace.resource.btt.ui.BttBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BttHighlighting(org.be.textbe.bttrace.resource.btt.IBttTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.be.textbe.bttrace.resource.btt.ui.BttColorManager colorManager, org.be.textbe.bttrace.resource.btt.ui.BttEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.be.textbe.bttrace.resource.btt.ui.BttTokenScanner(textResource, colorManager);
		occurrence = new org.be.textbe.bttrace.resource.btt.ui.BttOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.be.textbe.bttrace.resource.btt.ui.BttBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.be.textbe.bttrace.resource.btt.ui.BttPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.bttrace.resource.btt.ui.BttPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.be.textbe.bttrace.resource.btt.ui.BttEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.be.textbe.bttrace.resource.btt.ui.BttPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.be.textbe.bttrace.resource.btt.ui.BttPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.be.textbe.bttrace.resource.btt.ui.BttPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.be.textbe.bttrace.resource.btt.ui.BttEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
