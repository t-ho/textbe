 ...
 * 
 */
package org.be.textbe.st.textst.resource.st.ui.debug;

@SuppressWarnings("restriction")
public class StAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getSyntaxName())) {
					return new org.be.textbe.st.textst.resource.st.ui.debug.StLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.be.textbe.st.textst.resource.st.debug.StDebugVariable) {
			final org.be.textbe.st.textst.resource.st.debug.StDebugVariable variable = (org.be.textbe.st.textst.resource.st.debug.StDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.be.textbe.st.textst.resource.st.debug.StDebugVariable) {
			final org.be.textbe.st.textst.resource.st.debug.StDebugVariable variable = (org.be.textbe.st.textst.resource.st.debug.StDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.be.textbe.st.textst.resource.st.debug.StDebugValue castedValue = (org.be.textbe.st.textst.resource.st.debug.StDebugValue) value;
