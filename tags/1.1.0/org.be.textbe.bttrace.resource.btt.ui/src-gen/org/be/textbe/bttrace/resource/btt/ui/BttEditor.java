...
/**
 * A text editor for 'btt' models.
 */
public class BttEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.be.textbe.bttrace.resource.btt.IBttResourceProvider, org.be.textbe.bttrace.resource.btt.ui.IBttBracketHandlerProvider, org.be.textbe.bttrace.resource.btt.ui.IBttAnnotationModelProvider {
	
	private org.be.textbe.bttrace.resource.btt.ui.BttHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.be.textbe.bttrace.resource.btt.ui.BttCodeFoldingManager codeFoldingManager;
	private org.be.textbe.bttrace.resource.btt.ui.BttBackgroundParsingStrategy bgParsingStrategy = new org.be.textbe.bttrace.resource.btt.ui.BttBackgroundParsingStrategy();
	private java.util.Collection<org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener>();
	private org.be.textbe.bttrace.resource.btt.ui.BttColorManager colorManager = new org.be.textbe.bttrace.resource.btt.ui.BttColorManager();
	private org.be.textbe.bttrace.resource.btt.ui.BttOutlinePage outlinePage;
	...
	private org.be.textbe.bttrace.resource.btt.ui.BttPropertySheetPage propertySheetPage;
	...
	private org.be.textbe.bttrace.resource.btt.ui.IBttBracketHandler bracketHandler;
	...
	public BttEditor() {
		super();
		setSourceViewerConfiguration(new org.be.textbe.bttrace.resource.btt.ui.BttEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BttEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.be.textbe.bttrace.resource.btt.IBttTextResource currentResource = getResource();
				...
				org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.be.textbe.bttrace.resource.btt.EditorContext");
		setRulerContextMenuId("org.be.textbe.bttrace.resource.btt.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.be.textbe.bttrace.resource.btt.ui.BttHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.be.textbe.bttrace.resource.btt.ui.BttCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.be.textbe.bttrace.resource.btt.mopp.BttNature.activate(inputFile.getProject());
		...
		org.be.textbe.bttrace.resource.btt.IBttTextResource loadedResource = (org.be.textbe.bttrace.resource.btt.IBttTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.be.textbe.bttrace.resource.btt.IBttTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.be.textbe.bttrace.resource.btt.IBttTextResource) {
					setResource((org.be.textbe.bttrace.resource.btt.IBttTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BttEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.be.textbe.bttrace.resource.btt.IBttTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.be.textbe.bttrace.resource.btt.ui.BttOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.be.textbe.bttrace.resource.btt.ui.BttPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.be.textbe.bttrace.resource.btt.IBttTextResource textResource = (org.be.textbe.bttrace.resource.btt.IBttTextResource) element.eResource();
			...
			org.be.textbe.bttrace.resource.btt.IBttTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.be.textbe.bttrace.resource.btt.IBttTextToken token = lexer.getNextToken();
			...
			org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BttEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.be.textbe.bttrace.resource.btt.ui.IBttBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.be.textbe.bttrace.resource.btt.ui.IBttBracketHandler bracketHandler) {
