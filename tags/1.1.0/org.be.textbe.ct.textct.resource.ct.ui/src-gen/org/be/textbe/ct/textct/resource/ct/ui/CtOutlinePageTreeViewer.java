 ...
 * a specified depth.
 */
public class CtOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public CtOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.be.textbe.ct.textct.resource.ct.ui.CtEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.be.textbe.ct.textct.resource.ct.mopp.CtPlugin.logError("Exception while refreshing outline view", e);
		}
	}
