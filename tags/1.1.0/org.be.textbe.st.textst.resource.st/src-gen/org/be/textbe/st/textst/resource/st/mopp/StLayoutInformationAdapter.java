...
/**
 * A StLayoutInformationAdapter is used to store layout information that is found
 ...
 * StLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class StLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.be.textbe.st.textst.resource.st.mopp.StLayoutInformation> layoutInformations = new java.util.ArrayList<org.be.textbe.st.textst.resource.st.mopp.StLayoutInformation>();
	...
	public java.util.List<org.be.textbe.st.textst.resource.st.mopp.StLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.be.textbe.st.textst.resource.st.mopp.StLayoutInformation layoutInformation) {
