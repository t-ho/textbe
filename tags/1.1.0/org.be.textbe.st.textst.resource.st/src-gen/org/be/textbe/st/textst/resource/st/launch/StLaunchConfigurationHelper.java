 ...
 * delegates.
 */
public class StLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.be.textbe.st.textst.resource.st.util.AbstractStInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.be.textbe.st.textst.resource.st.util.AbstractStInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.be.textbe.st.textst.resource.st.debug.StDebuggableInterpreter<ResultType, ContextType> interpreter = new org.be.textbe.st.textst.resource.st.debug.StDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.be.textbe.st.textst.resource.st.debug.StDebuggerListener<ResultType, ContextType> debugListener = new org.be.textbe.st.textst.resource.st.debug.StDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.be.textbe.st.textst.resource.st.debug.StDebugProcess process = new org.be.textbe.st.textst.resource.st.debug.StDebugProcess(launch);
		launch.addDebugTarget(new org.be.textbe.st.textst.resource.st.debug.StDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.be.textbe.st.textst.resource.st.launch.StLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.be.textbe.st.textst.resource.st.util.StResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.be.textbe.st.textst.resource.st.mopp.StPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
