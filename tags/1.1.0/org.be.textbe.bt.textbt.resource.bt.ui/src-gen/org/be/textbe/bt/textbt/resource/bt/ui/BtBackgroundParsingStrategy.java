...
public class BtBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.be.textbe.bt.textbt.resource.bt.IBtTextResource resource, final org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.be.textbe.bt.textbt.resource.bt.IBtTextResource resource, final org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.be.textbe.bt.textbt.resource.bt.IBtTextResource resource, final org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
