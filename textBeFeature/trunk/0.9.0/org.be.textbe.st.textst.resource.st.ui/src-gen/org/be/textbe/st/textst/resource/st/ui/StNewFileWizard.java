...
public class StNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.be.textbe.st.textst.resource.st.ui.StNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public StNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.be.textbe.st.textst.resource.st.ui.StNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.be.textbe.st.textst.resource.st.ui.StUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.be.textbe.st.textst.resource.st.ui.StUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getSyntaxName();
	}
	
	public org.be.textbe.st.textst.resource.st.IStMetaInformation getMetaInformation() {
