...
public class BtEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.be.textbe.bt.textbt.resource.bt.ui.BtQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public BtEditorConfiguration(org.be.textbe.bt.textbt.resource.bt.IBtResourceProvider resourceProvider, org.be.textbe.bt.textbt.resource.bt.ui.IBtAnnotationModelProvider annotationModelProvider, org.be.textbe.bt.textbt.resource.bt.ui.IBtBracketHandlerProvider bracketHandlerProvider, org.be.textbe.bt.textbt.resource.bt.ui.BtColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.be.textbe.bt.textbt.resource.bt.ui.BtCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.be.textbe.bt.textbt.resource.bt.ui.BtTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.be.textbe.bt.textbt.resource.bt.ui.BtTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.be.textbe.bt.textbt.resource.bt.ui.BtHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.be.textbe.bt.textbt.resource.bt.ui.BtQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
