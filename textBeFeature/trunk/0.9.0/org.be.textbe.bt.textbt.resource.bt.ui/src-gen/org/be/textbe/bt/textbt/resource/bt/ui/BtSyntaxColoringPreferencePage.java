 ...
 */
public class BtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BtSyntaxColoringPreferencePage() {
		super();
		
		org.be.textbe.bt.textbt.resource.bt.IBtMetaInformation syntaxPlugin = new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bt.textbt.resource.bt.ui.BtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.be.textbe.bt.textbt.resource.bt.ui.BtPixelConverter pixelConverter = new org.be.textbe.bt.textbt.resource.bt.ui.BtPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) {
			org.be.textbe.bt.textbt.resource.bt.ui.BtEditor emfTextEditor = (org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) editor;
