...
/**
 * A IStReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IStReferenceResolverSwitch extends org.be.textbe.st.textst.resource.st.IStConfigurable {
