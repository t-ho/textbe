 ...
 */
public class BttTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.be.textbe.bttrace.resource.btt.IBttHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput infoInput = (org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.be.textbe.bttrace.resource.btt.ui.BttHyperlink hyperlink = new org.be.textbe.bttrace.resource.btt.ui.BttHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl iControl = new org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput) {
							org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput input = (org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl.isAvailable(parent)) {
				org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl iControl = new org.be.textbe.bttrace.resource.btt.ui.BttBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BttTextHover(org.be.textbe.bttrace.resource.btt.IBttResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.be.textbe.bttrace.resource.btt.ui.BttUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.insertPageProlog(buffer, 0, org.be.textbe.bttrace.resource.btt.ui.BttTextHover.getStyleSheet());
			org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.addPageEpilog(buffer);
			return new org.be.textbe.bttrace.resource.btt.ui.BttDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.be.textbe.bttrace.resource.btt.ui.BttHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.be.textbe.bttrace.resource.btt.util.BttStreamUtil.getContent(styleSheetURL.openStream());
