 ...
 */
public class BttSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BttSyntaxColoringPreferencePage() {
		super();
		
		org.be.textbe.bttrace.resource.btt.IBttMetaInformation syntaxPlugin = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.be.textbe.bttrace.resource.btt.ui.BttSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.be.textbe.bttrace.resource.btt.ui.BttPixelConverter pixelConverter = new org.be.textbe.bttrace.resource.btt.ui.BttPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.be.textbe.bttrace.resource.btt.ui.BttEditor) {
			org.be.textbe.bttrace.resource.btt.ui.BttEditor emfTextEditor = (org.be.textbe.bttrace.resource.btt.ui.BttEditor) editor;
