 ...
 */
public class BttNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BttNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new btt file");
