 ...
 */
public class BttUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.be.textbe.bttrace.resource.btt.ui";
	public static final String EDITOR_ID = "org.be.textbe.bttrace.resource.btt.ui.BttEditor";
	...
	private static BttUIPlugin plugin;
	...
	public static BttUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BttUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BttUIPlugin.PLUGIN_ID, message);
		}
		final BttUIPlugin pluginInstance = BttUIPlugin.getDefault();
