...
/**
 * A ICtReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface ICtReferenceResolverSwitch extends org.be.textbe.ct.textct.resource.ct.ICtConfigurable {
