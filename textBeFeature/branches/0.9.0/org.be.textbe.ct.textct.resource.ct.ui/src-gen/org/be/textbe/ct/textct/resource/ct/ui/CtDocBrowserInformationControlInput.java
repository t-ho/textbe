 ...
 * olInput</code>.
 */
public class CtDocBrowserInformationControlInput {
	
	private final CtDocBrowserInformationControlInput fPrevious;
	private CtDocBrowserInformationControlInput fNext;
	 ...
	 */
	public CtDocBrowserInformationControlInput(CtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public CtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public CtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
