 ...
 */
public class CtDefaultTokenResolver implements org.be.textbe.ct.textct.resource.ct.ICtTokenResolver {
	 ...
	 */
	public CtDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.be.textbe.ct.textct.resource.ct.ICtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.be.textbe.ct.textct.resource.ct.grammar.CtGrammarInformationProvider.INSTANCE.getKeywords()) {
