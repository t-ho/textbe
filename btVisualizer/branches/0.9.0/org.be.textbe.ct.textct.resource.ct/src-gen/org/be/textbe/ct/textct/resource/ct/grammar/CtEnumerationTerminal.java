 ...
 */
public class CtEnumerationTerminal extends org.be.textbe.ct.textct.resource.ct.grammar.CtTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public CtEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.be.textbe.ct.textct.resource.ct.grammar.CtCardinality cardinality, int mandatoryOccurrencesAfter) {
