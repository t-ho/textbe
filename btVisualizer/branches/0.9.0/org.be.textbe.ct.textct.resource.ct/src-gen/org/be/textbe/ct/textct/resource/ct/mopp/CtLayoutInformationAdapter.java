...
/**
 * A CtLayoutInformationAdapter is used to store layout information that is found
 ...
 * CtLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class CtLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.be.textbe.ct.textct.resource.ct.mopp.CtLayoutInformation> layoutInformations = new java.util.ArrayList<org.be.textbe.ct.textct.resource.ct.mopp.CtLayoutInformation>();
	...
	public java.util.List<org.be.textbe.ct.textct.resource.ct.mopp.CtLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.be.textbe.ct.textct.resource.ct.mopp.CtLayoutInformation layoutInformation) {
