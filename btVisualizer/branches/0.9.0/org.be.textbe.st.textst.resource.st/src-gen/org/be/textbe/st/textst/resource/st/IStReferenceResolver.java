 ...
 * resolver
 */
public interface IStReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends org.be.textbe.st.textst.resource.st.IStConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.be.textbe.st.textst.resource.st.IStReferenceResolveResult<ReferenceType> result);
