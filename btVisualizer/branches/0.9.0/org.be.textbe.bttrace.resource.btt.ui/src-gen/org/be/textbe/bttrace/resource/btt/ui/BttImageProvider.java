 ...
 */
public class BttImageProvider {
	
	public final static BttImageProvider INSTANCE = new BttImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
