 ...
 * <ul>
 *   <li>{@link org.be.textbe.ct.textct.impl.RequirementListImpl#getRequirements <em>Requirements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequirementListImpl extends EObjectImpl implements RequirementList {
   ...
   */
    ...
    return TextctPackage.Literals.REQUIREMENT_LIST;
  }
   ...
   */
    ...
    {
      requirements = new EObjectContainmentEList<Requirement>(Requirement.class, this, TextctPackage.REQUIREMENT_LIST__REQUIREMENTS);
    }
    return requirements;
  }
   ...
   */
    ...
    switch (featureID)
    {
      case TextctPackage.REQUIREMENT_LIST__REQUIREMENTS:
