 ...
 */
public class StLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.be.textbe.st.textst.resource.st.launch.StLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.be.textbe.st.textst.resource.st.mopp.StPlugin.logError("Exception while launching selection", e);
		}
	}
