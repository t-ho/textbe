 ...
 */
public class StUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.be.textbe.st.textst.resource.st.ui";
	public static final String EDITOR_ID = "org.be.textbe.st.textst.resource.st.ui.StEditor";
	...
	private static StUIPlugin plugin;
	...
	public static StUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, StUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, StUIPlugin.PLUGIN_ID, message);
		}
		final StUIPlugin pluginInstance = StUIPlugin.getDefault();
