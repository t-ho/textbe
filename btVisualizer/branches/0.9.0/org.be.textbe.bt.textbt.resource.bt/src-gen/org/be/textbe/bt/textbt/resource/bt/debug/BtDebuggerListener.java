 ...
 * code).
 */
public class BtDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.be.textbe.bt.textbt.resource.bt.debug.AbstractBtDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.be.textbe.bt.textbt.resource.bt.util.BtPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.be.textbe.bt.textbt.resource.bt.util.BtPair<String, Object>>();
	...
	public BtDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.be.textbe.bt.textbt.resource.bt.util.BtStringUtil.encode('#', stack);
				org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage message = new org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage message = new org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_VARIABLES)) {
				...
				org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage message = new org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage(org.be.textbe.bt.textbt.resource.bt.debug.EBtDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.be.textbe.bt.textbt.resource.bt.util.BtStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.be.textbe.bt.textbt.resource.bt.util.BtPair<String, Object> pair = new org.be.textbe.bt.textbt.resource.bt.util.BtPair<String, Object>(name, value);
	...
	public org.be.textbe.bt.textbt.resource.bt.debug.AbstractBtDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.be.textbe.bt.textbt.resource.bt.debug.AbstractBtDebuggable debuggable) {
