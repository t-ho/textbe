...
public abstract class BtAbstractExpectedElement implements org.be.textbe.bt.textbt.resource.bt.IBtExpectedElement {
	...
	private java.util.Set<org.be.textbe.bt.textbt.resource.bt.util.BtPair<org.be.textbe.bt.textbt.resource.bt.IBtExpectedElement, org.eclipse.emf.ecore.EStructuralFeature[]>> followers = new java.util.LinkedHashSet<org.be.textbe.bt.textbt.resource.bt.util.BtPair<org.be.textbe.bt.textbt.resource.bt.IBtExpectedElement, org.eclipse.emf.ecore.EStructuralFeature[]>>();
	...
	public void addFollower(org.be.textbe.bt.textbt.resource.bt.IBtExpectedElement follower, org.eclipse.emf.ecore.EStructuralFeature[] path) {
		followers.add(new org.be.textbe.bt.textbt.resource.bt.util.BtPair<org.be.textbe.bt.textbt.resource.bt.IBtExpectedElement, org.eclipse.emf.ecore.EStructuralFeature[]>(follower, path));
	}
