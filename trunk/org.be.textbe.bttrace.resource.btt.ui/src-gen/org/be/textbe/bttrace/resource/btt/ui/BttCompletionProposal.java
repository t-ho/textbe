 ...
 */
public class BttCompletionProposal implements java.lang.Comparable<BttCompletionProposal> {
	...
	public BttCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public BttCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public BttCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof BttCompletionProposal) {
			BttCompletionProposal other = (BttCompletionProposal) object;
	...
	public int compareTo(BttCompletionProposal object) {
		if (object instanceof BttCompletionProposal) {
			BttCompletionProposal other = (BttCompletionProposal) object;
