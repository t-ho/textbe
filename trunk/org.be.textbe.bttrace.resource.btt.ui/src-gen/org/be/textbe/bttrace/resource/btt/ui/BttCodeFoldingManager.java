 ...
 */
public class BttCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.be.textbe.bttrace.resource.btt.IBttBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.be.textbe.bttrace.resource.btt.ui.BttEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.be.textbe.bttrace.resource.btt.ui.BttEditor) {
				org.be.textbe.bttrace.resource.btt.ui.BttEditor editor = (org.be.textbe.bttrace.resource.btt.ui.BttEditor) workbenchPart;
	...
	protected org.be.textbe.bttrace.resource.btt.ui.BttEditor editor;
	 ...
	 */
	public BttCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.be.textbe.bttrace.resource.btt.ui.BttEditor textEditor) {
	...
	private void addCloseListener(final org.be.textbe.bttrace.resource.btt.ui.BttEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.be.textbe.bttrace.resource.btt.ui.BttUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.be.textbe.bttrace.resource.btt.IBttTextResource textResource = (org.be.textbe.bttrace.resource.btt.IBttTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
