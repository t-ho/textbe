 ...
 */
public class BttNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.be.textbe.bttrace.resource.btt.ui");
							...
							String natureID = org.be.textbe.bttrace.resource.btt.mopp.BttNature.NATURE_ID;
							...
							for (String builderID : org.be.textbe.bttrace.resource.btt.mopp.BttNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation info = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation();
