 ...
 */
public class StDefaultTokenResolver implements org.be.textbe.st.textst.resource.st.IStTokenResolver {
	 ...
	 */
	public StDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.be.textbe.st.textst.resource.st.IStTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.be.textbe.st.textst.resource.st.grammar.StGrammarInformationProvider.INSTANCE.getKeywords()) {
