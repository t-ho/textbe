...
/**
 * A StLayoutInformation is used to store layout information that is found while
 ...
 * StLayoutInformations are aggregated in LayoutInformationAdapters. One
 * StLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class StLayoutInformation {
	
	private final org.be.textbe.st.textst.resource.st.grammar.StSyntaxElement syntaxElement;
	...
	public StLayoutInformation(org.be.textbe.st.textst.resource.st.grammar.StSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.be.textbe.st.textst.resource.st.grammar.StSyntaxElement getSyntaxElement() {
