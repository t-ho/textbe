...
public class BttraceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BttracePackage.TEXT_BT_TRACE: {
				TextBTTrace textBTTrace = (TextBTTrace)theEObject;
				T result = caseTextBTTrace(textBTTrace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.BT: {
				BT bt = (BT)theEObject;
				T result = caseBT(bt);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.DELAY: {
				Delay delay = (Delay)theEObject;
				T result = caseDelay(delay);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.ACTIVATE: {
				Activate activate = (Activate)theEObject;
				T result = caseActivate(activate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.INTERLEAVE: {
				Interleave interleave = (Interleave)theEObject;
				T result = caseInterleave(interleave);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.TRACE: {
				Trace trace = (Trace)theEObject;
				T result = caseTrace(trace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.NODE_GROUP: {
				NodeGroup nodeGroup = (NodeGroup)theEObject;
				T result = caseNodeGroup(nodeGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BttracePackage.NODE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Text BT Trace</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Text BT Trace</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTextBTTrace(TextBTTrace object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Interleave</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Interleave</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterleave(Interleave object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseNodeGroup(NodeGroup object) {
		return null;
	}
