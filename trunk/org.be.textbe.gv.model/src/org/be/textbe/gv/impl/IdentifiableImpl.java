 ...
 * <ul>
 *   <li>{@link org.be.textbe.gv.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiableImpl extends EObjectImpl implements Identifiable
{
  ...
  {
		return GvPackage.Literals.IDENTIFIABLE;
	}
  ...
  public void setId(String newId)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GvPackage.IDENTIFIABLE__ID, oldId, id));
	}
  ...
  {
		switch (featureID) {
			case GvPackage.IDENTIFIABLE__ID:
				return getId();
		}
