...
public abstract class BtSyntaxElement {
	...
	private org.be.textbe.bt.textbt.resource.bt.grammar.BtCardinality cardinality;
	
	public BtSyntaxElement(org.be.textbe.bt.textbt.resource.bt.grammar.BtCardinality cardinality, BtSyntaxElement[] children) {
	...
	public org.be.textbe.bt.textbt.resource.bt.grammar.BtCardinality getCardinality() {
		return cardinality;
	}
