...
public class BtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPositionHelper positionHelper = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPositionHelper();
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtTokenScanner scanner;
	...
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtOccurrence occurrence;
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.be.textbe.bt.v1.textbt.resource.bt.IBtBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BtHighlighting(org.be.textbe.bt.v1.textbt.resource.bt.IBtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtColorManager colorManager, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtTokenScanner(textResource, colorManager);
		occurrence = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.be.textbe.bt.v1.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
