...
public class BtAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName())) {
					return new org.be.textbe.bt.textbt.resource.bt.ui.debug.BtLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable) {
			final org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable variable = (org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable) {
			final org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable variable = (org.be.textbe.bt.textbt.resource.bt.debug.BtDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.be.textbe.bt.textbt.resource.bt.debug.BtDebugValue castedValue = (org.be.textbe.bt.textbt.resource.bt.debug.BtDebugValue) value;
