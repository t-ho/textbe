...
public class BtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.be.textbe.bt.v1.textbt.resource.bt.ui.BtNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public BtNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.be.textbe.bt.v1.textbt.resource.bt.ui.BtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.be.textbe.bt.v1.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.be.textbe.bt.v1.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName();
	}
	
	public org.be.textbe.bt.v1.textbt.resource.bt.IBtMetaInformation getMetaInformation() {
