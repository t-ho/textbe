 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt.textbt.component.impl.MemberImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemberImpl extends NamedElementImpl implements Member {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentPackage.MEMBER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(ComponentType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.MEMBER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.MEMBER__TYPE:
