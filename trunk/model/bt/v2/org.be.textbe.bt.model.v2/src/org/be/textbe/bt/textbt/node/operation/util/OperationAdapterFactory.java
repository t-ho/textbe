...
public class OperationAdapterFactory extends AdapterFactoryImpl {
	...
	protected OperationSwitch<Adapter> modelSwitch =
		new OperationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStartNewNode(StartNewNode object) {
				return createStartNewNodeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.be.textbe.bt.textbt.node.operation.StartNewNode <em>Start New Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStartNewNodeAdapter() {
		return null;
	}
