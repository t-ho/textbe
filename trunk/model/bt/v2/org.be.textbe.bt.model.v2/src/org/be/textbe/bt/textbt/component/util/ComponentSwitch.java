...
public class ComponentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ComponentPackage.SINGLETON: {
				Singleton singleton = (Singleton)theEObject;
				T result = caseSingleton(singleton);
				if (result == null) result = caseComponent(singleton);
				if (result == null) result = caseNamedElement(singleton);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentPackage.MEMBER: {
				...
				if (result == null) result = caseComponent(member);
