 ...
 * <ul>
 *   <li>{@link org.be.textbe.bt.textbt.node.behavior.event.impl.EventImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends BehaviorImpl implements Event {
	...
	public void setExpression(Object newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventPackage.EVENT__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventPackage.EVENT__EXPRESSION:
