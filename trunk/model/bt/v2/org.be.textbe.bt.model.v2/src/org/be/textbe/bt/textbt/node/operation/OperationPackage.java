...
public interface OperationPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.be.textbe.bt.textbt.node.operation.impl.StartNewNodeImpl <em>Start New Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.be.textbe.bt.textbt.node.operation.impl.StartNewNodeImpl
	 * @see org.be.textbe.bt.textbt.node.operation.impl.OperationPackageImpl#getStartNewNode()
	 * @generated
	 */
	int START_NEW_NODE = 6;
	 ...
	 * @ordered
	 */
	int START_NEW_NODE__REVERT_TO = REVERSION__REVERT_TO;

	/**
	 * The number of structural features of the '<em>Start New Node</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int START_NEW_NODE_FEATURE_COUNT = REVERSION_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link org.be.textbe.bt.textbt.node.operation.StartNewNode <em>Start New Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Start New Node</em>'.
	 * @see org.be.textbe.bt.textbt.node.operation.StartNewNode
	 * @generated
	 */
	EClass getStartNewNode();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link org.be.textbe.bt.textbt.node.operation.impl.StartNewNodeImpl <em>Start New Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.be.textbe.bt.textbt.node.operation.impl.StartNewNodeImpl
		 * @see org.be.textbe.bt.textbt.node.operation.impl.OperationPackageImpl#getStartNewNode()
		 * @generated
		 */
		EClass START_NEW_NODE = eINSTANCE.getStartNewNode();
