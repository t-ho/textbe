...
public class _jet_transformation implements JET2TemplateLoader,
    ...
    static {
        pathToTemplateOrdinalMap.put("templates/gv.jet", //$NON-NLS-1$
                Integer.valueOf(0));
    ...
    public JET2Template getTemplate(final String templatePath) {
        ...
        if(ordinal != null) {
           switch (ordinal.intValue()) {
            case 0: // templates/gv.jet
                return new org.be.textbe.gv.gv2text.compiled._jet_gv();
            case 1: // templates/main.jet
                return new org.be.textbe.gv.gv2text.compiled._jet_main();
            default:
                break;
            }
        }
