 ...
 * code).
 */
public class CtDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.be.textbe.ct.textct.resource.ct.debug.AbstractCtDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.be.textbe.ct.textct.resource.ct.util.CtPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.be.textbe.ct.textct.resource.ct.util.CtPair<String, Object>>();
	...
	public CtDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.be.textbe.ct.textct.resource.ct.util.CtStringUtil.encode('#', stack);
				org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message = new org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message = new org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_VARIABLES)) {
				...
				org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage message = new org.be.textbe.ct.textct.resource.ct.debug.CtDebugMessage(org.be.textbe.ct.textct.resource.ct.debug.ECtDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.be.textbe.ct.textct.resource.ct.util.CtStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.be.textbe.ct.textct.resource.ct.util.CtPair<String, Object> pair = new org.be.textbe.ct.textct.resource.ct.util.CtPair<String, Object>(name, value);
	...
	public org.be.textbe.ct.textct.resource.ct.debug.AbstractCtDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.be.textbe.ct.textct.resource.ct.debug.AbstractCtDebuggable debuggable) {
