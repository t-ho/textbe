...
public class BtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.ui.BtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
