...
public class BtBracketSet {
	...
	private java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.IBtBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.be.textbe.bt.textbt.resource.bt.IBtBracketPair {
	 ...
	 */
	private class ClosingListener implements org.be.textbe.bt.textbt.resource.bt.ui.IBtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public BtBracketSet(org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.IBtBracketPair>();
	 ...
	 */
	public org.be.textbe.bt.textbt.resource.bt.IBtBracketPair getBracketPair(String opening, String closing) {
		for (org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair : bracketPairs) {
	...
	public org.be.textbe.bt.textbt.resource.bt.IBtBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.be.textbe.bt.textbt.resource.bt.IBtBracketPair remove(String opening, String closing) {
		for (org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.IBtBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
