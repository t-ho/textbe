 ...
 */
public class BtDefaultTokenResolver implements org.be.textbe.bt.textbt.resource.bt.IBtTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.be.textbe.bt.textbt.resource.bt.IBtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.be.textbe.bt.textbt.resource.bt.grammar.BtGrammarInformationProvider.INSTANCE.getKeywords()) {
