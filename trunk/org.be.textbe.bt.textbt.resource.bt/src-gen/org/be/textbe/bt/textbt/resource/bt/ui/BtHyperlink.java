...
public class BtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public BtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) {
					org.be.textbe.bt.textbt.resource.bt.ui.BtEditor emftEditor = (org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) editorPart;
