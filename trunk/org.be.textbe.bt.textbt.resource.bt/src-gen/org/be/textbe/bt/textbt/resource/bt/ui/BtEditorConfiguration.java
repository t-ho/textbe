...
public class BtEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.be.textbe.bt.textbt.resource.bt.ui.BtEditor theEditor;
	...
	// @param colorManager
	///
	public BtEditorConfiguration(org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor, org.be.textbe.bt.textbt.resource.bt.ui.BtColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.be.textbe.bt.textbt.resource.bt.ui.BtCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.be.textbe.bt.textbt.resource.bt.ui.BtTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.be.textbe.bt.textbt.resource.bt.ui.BtHyperlinkDetector(theEditor.getResource()) };
	}
