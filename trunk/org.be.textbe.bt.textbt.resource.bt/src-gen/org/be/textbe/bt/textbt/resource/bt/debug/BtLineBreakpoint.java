...
public class BtLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	...
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.be.textbe.bt.textbt.resource.bt.debug.lineBreakpoint.marker";
	...
	public void install(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget target) {
		try {
	...
	public void remove(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
