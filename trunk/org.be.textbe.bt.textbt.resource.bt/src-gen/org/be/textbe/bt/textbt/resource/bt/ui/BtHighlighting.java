...
public class BtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.be.textbe.bt.textbt.resource.bt.ui.BtPositionHelper positionHelper = new org.be.textbe.bt.textbt.resource.bt.ui.BtPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.be.textbe.bt.textbt.resource.bt.ui.BtTokenScanner scanner;
	...
	private org.be.textbe.bt.textbt.resource.bt.ui.BtOccurrence occurrence;
	private org.be.textbe.bt.textbt.resource.bt.ui.BtBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.be.textbe.bt.textbt.resource.bt.IBtBackgroundParsingListener {
	...
	public BtHighlighting(org.be.textbe.bt.textbt.resource.bt.IBtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.be.textbe.bt.textbt.resource.bt.ui.BtColorManager colorManager, org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.be.textbe.bt.textbt.resource.bt.ui.BtTokenScanner(colorManager);
		occurrence = new org.be.textbe.bt.textbt.resource.bt.ui.BtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.be.textbe.bt.textbt.resource.bt.ui.BtBracketSet(sourceviewer, "bt");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.be.textbe.bt.textbt.resource.bt.ui.BtEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.DEFINTION.toString()) || category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.be.textbe.bt.textbt.resource.bt.ui.BtPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.be.textbe.bt.textbt.resource.bt.ui.BtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.be.textbe.bt.textbt.resource.bt.IBtTextResource) {
