...
public class BtBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private String BRACKETS_COLOR = org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName();
	
	private org.be.textbe.bt.textbt.resource.bt.ui.BtBracketSet bracketsTmp;
	...
	public BtBracketPreferencePage() {
		...
		org.be.textbe.bt.textbt.resource.bt.IBtMetaInformation metaInformation = new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.be.textbe.bt.textbt.resource.bt.ui.BtBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.be.textbe.bt.textbt.resource.bt.IBtBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.be.textbe.bt.textbt.resource.bt.ui.BtPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) {
			((org.be.textbe.bt.textbt.resource.bt.ui.BtEditor) editor).invalidateTextRepresentation();
		}
	}
