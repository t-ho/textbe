...
//
public class BtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	public BtEditor() {
		...
		setSourceViewerConfiguration(new org.be.textbe.bt.textbt.resource.bt.ui.BtEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.be.textbe.bt.textbt.resource.bt.IBtBackgroundParsingListener {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.be.textbe.bt.textbt.resource.bt.IBtTextResource) {
					...
					org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BtEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.be.textbe.bt.textbt.resource.bt.ui.BtMarkerHelper.unmark(resourceToRefresh);
						org.be.textbe.bt.textbt.resource.bt.ui.BtMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
