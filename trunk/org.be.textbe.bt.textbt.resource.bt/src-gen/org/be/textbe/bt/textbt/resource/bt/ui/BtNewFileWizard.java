...
public class BtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private org.be.textbe.bt.textbt.resource.bt.ui.BtNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.be.textbe.bt.textbt.resource.bt.ui.BtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.be.textbe.bt.textbt.resource.bt.mopp.BtPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName();
	}
