...
public class BtDebugTarget extends org.be.textbe.bt.textbt.resource.bt.debug.BtDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.be.textbe.bt.textbt.resource.bt.debug.BtDebugProcess process;
	...
	private org.be.textbe.bt.textbt.resource.bt.debug.BtDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener> eventListeners = new java.util.ArrayList<org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener>();
	
	private org.be.textbe.bt.textbt.resource.bt.debug.BtDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public BtDebugTarget(org.be.textbe.bt.textbt.resource.bt.debug.BtDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.be.textbe.bt.textbt.resource.bt.debug.BtDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.be.textbe.bt.textbt.resource.bt.debug.BtDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.be.textbe.bt.textbt.resource.bt.debug.IBtDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.be.textbe.bt.textbt.resource.bt.mopp.BtMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.be.textbe.bt.textbt.resource.bt.debug.BtLineBreakpoint lineBreakpoint = (org.be.textbe.bt.textbt.resource.bt.debug.BtLineBreakpoint) breakpoint;
	...
	public org.be.textbe.bt.textbt.resource.bt.debug.BtDebugProxy getDebugProxy() {
