...
public class BtNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "org.be.textbe.bt.textbt.resource.bt.nature";
	
	private org.eclipse.core.resources.IProject project;
	
	// the IDs of all builders, IDs of additional builders can be added here
	public final static String[] BUILDER_IDS = {org.be.textbe.bt.textbt.resource.bt.mopp.BtBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.be.textbe.bt.textbt.resource.bt.mopp.BtBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
