 ...
 * <ul>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getComponentSet <em>Component Set</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getMci <em>Mci</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getSecondQualifier <em>Second Qualifier</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getBehaviorRef <em>Behavior Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getRequirementRef <em>Requirement Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getTraceabilityStatus <em>Traceability Status</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.DefinedByNodeImpl#getChildNode <em>Child Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DefinedByNodeImpl extends AbstractBlockOrNodeImpl implements DefinedByNode
{
  ...
  public EList<String> getRequirementRef()
  {
    ...
    {
      requirementRef = new EDataTypeUniqueEList<String>(String.class, this, TextstPackage.DEFINED_BY_NODE__REQUIREMENT_REF);
    }
