 ...
 * <ul>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getComponentSet <em>Component Set</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getMci <em>Mci</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getSecondQualifier <em>Second Qualifier</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getBehaviorRef <em>Behavior Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getRequirementRef <em>Requirement Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getTraceabilityStatus <em>Traceability Status</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.AbstractNodeImpl#getChildNode <em>Child Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractNodeImpl extends AbstractBlockOrNodeImpl implements AbstractNode
{
  ...
  {
    return TextstPackage.Literals.ABSTRACT_NODE;
  }
  ...
  public void setComponentRef(String newComponentRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__COMPONENT_REF, oldComponentRef, componentRef));
  }
  ...
  public void setComponentSet(String newComponentSet)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__COMPONENT_SET, oldComponentSet, componentSet));
  }
  ...
  public void setMci(String newMci)
  {
    ...
    mci = newMci;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__MCI, oldMci, mci));
  }
  ...
  public void setQualifier(Qualifier newQualifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__QUALIFIER, oldQualifier, qualifier));
  }
  ...
  public void setSecondQualifier(Qualifier newSecondQualifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__SECOND_QUALIFIER, oldSecondQualifier, secondQualifier));
  }
  ...
  public void setBehaviorRef(String newBehaviorRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__BEHAVIOR_REF, oldBehaviorRef, behaviorRef));
  }
  ...
  public EList<String> getRequirementRef()
  {
    ...
    {
      requirementRef = new EDataTypeUniqueEList<String>(String.class, this, TextstPackage.ABSTRACT_NODE__REQUIREMENT_REF);
    }
  ...
  public void setTraceabilityStatus(Validity newTraceabilityStatus)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__TRACEABILITY_STATUS, oldTraceabilityStatus, traceabilityStatus));
  }
  ...
  public void setOperator(String newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain basicSetChildNode(AbstractBlockOrNode newChildNode, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__CHILD_NODE, oldChildNode, newChildNode);
  ...
  public void setChildNode(AbstractBlockOrNode newChildNode)
  {
    if (newChildNode != childNode)
    {
      ...
      if (childNode != null)
        msgs = ((InternalEObject)childNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TextstPackage.ABSTRACT_NODE__CHILD_NODE, null, msgs);
      if (newChildNode != null)
        msgs = ((InternalEObject)newChildNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TextstPackage.ABSTRACT_NODE__CHILD_NODE, null, msgs);
      msgs = basicSetChildNode(newChildNode, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextstPackage.ABSTRACT_NODE__CHILD_NODE, newChildNode, newChildNode));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TextstPackage.ABSTRACT_NODE__CHILD_NODE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TextstPackage.ABSTRACT_NODE__COMPONENT_REF:
        return getComponentRef();
      case TextstPackage.ABSTRACT_NODE__COMPONENT_SET:
        return getComponentSet();
      case TextstPackage.ABSTRACT_NODE__MCI:
        return getMci();
      case TextstPackage.ABSTRACT_NODE__QUALIFIER:
        return getQualifier();
      case TextstPackage.ABSTRACT_NODE__SECOND_QUALIFIER:
        return getSecondQualifier();
      case TextstPackage.ABSTRACT_NODE__BEHAVIOR_REF:
        return getBehaviorRef();
      case TextstPackage.ABSTRACT_NODE__REQUIREMENT_REF:
        return getRequirementRef();
      case TextstPackage.ABSTRACT_NODE__TRACEABILITY_STATUS:
        return getTraceabilityStatus();
      case TextstPackage.ABSTRACT_NODE__OPERATOR:
        return getOperator();
      case TextstPackage.ABSTRACT_NODE__CHILD_NODE:
        return getChildNode();
    }
