 ...
 * <ul>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getBehaviorRef <em>Behavior Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getPrimaryLowerBound <em>Primary Lower Bound</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getPrimaryUpperBound <em>Primary Upper Bound</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getSecondaryLowerBound <em>Secondary Lower Bound</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getSecondaryUpperBound <em>Secondary Upper Bound</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getComponentAttribute <em>Component Attribute</em>}</li>
 *   <li>{@link org.be.textbe.st.textst.impl.SecondaryRelationImpl#getRelationName <em>Relation Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
