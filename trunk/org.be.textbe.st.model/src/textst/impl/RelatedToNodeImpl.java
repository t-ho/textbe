 ...
 * <ul>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getComponentSet <em>Component Set</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getMci <em>Mci</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getSecondQualifier <em>Second Qualifier</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getBehaviorRef <em>Behavior Ref</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getRequirementRef <em>Requirement Ref</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getTraceabilityStatus <em>Traceability Status</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link textst.impl.RelatedToNodeImpl#getChildNode <em>Child Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelatedToNodeImpl extends AbstractBlockOrNodeImpl implements RelatedToNode
{
  ...
  public EList getRequirementRef()
  {
    ...
    {
      requirementRef = new EDataTypeUniqueEList(String.class, this, TextstPackage.RELATED_TO_NODE__REQUIREMENT_REF);
    }
