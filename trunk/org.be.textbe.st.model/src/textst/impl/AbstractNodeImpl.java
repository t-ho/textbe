 ...
 * <ul>
 *   <li>{@link textst.impl.AbstractNodeImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getComponentSet <em>Component Set</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getMci <em>Mci</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getSecondQualifier <em>Second Qualifier</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getBehaviorRef <em>Behavior Ref</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getRequirementRef <em>Requirement Ref</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getTraceabilityStatus <em>Traceability Status</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link textst.impl.AbstractNodeImpl#getChildNode <em>Child Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractNodeImpl extends AbstractBlockOrNodeImpl implements AbstractNode
{
  ...
  public EList getRequirementRef()
  {
    ...
    {
      requirementRef = new EDataTypeUniqueEList(String.class, this, TextstPackage.ABSTRACT_NODE__REQUIREMENT_REF);
    }
