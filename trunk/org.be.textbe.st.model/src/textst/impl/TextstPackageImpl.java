...
import textst.AlternativeBlock;
...
import textst.ParallelBlock;
import textst.Qualifier;
import textst.RelatedToNode;
import textst.Requirement;
import textst.RequirementList;
import textst.SecondaryRelation;
import textst.StructureTree;
import textst.SystemComponent;
import textst.TextST;
import textst.TextstFactory;
...
public class TextstPackageImpl extends EPackageImpl implements TextstPackage
{
   ...
   * @see textst.TextstPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    addEEnumLiteral(qualifierEEnum, Qualifier.NULL_LITERAL);
    addEEnumLiteral(qualifierEEnum, Qualifier.NEGATED_LITERAL);
    addEEnumLiteral(qualifierEEnum, Qualifier.CONDITIONAL_LITERAL);
    addEEnumLiteral(qualifierEEnum, Qualifier.ASSERTION_LITERAL);

    initEEnum(validityEEnum, Validity.class, "Validity");
    addEEnumLiteral(validityEEnum, Validity.VALID_LITERAL);
    addEEnumLiteral(validityEEnum, Validity.IMPLIED_LITERAL);
    addEEnumLiteral(validityEEnum, Validity.INVALID_LITERAL);
    addEEnumLiteral(validityEEnum, Validity.DELETED_LITERAL);
    addEEnumLiteral(validityEEnum, Validity.REFINED_LITERAL);
    addEEnumLiteral(validityEEnum, Validity.UPDATED_LITERAL);
