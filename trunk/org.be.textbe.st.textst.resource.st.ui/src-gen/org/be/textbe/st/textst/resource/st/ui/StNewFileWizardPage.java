 ...
 */
public class StNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public StNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new st file");
