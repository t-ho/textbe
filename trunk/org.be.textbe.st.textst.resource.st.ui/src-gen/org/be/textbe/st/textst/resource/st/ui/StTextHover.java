 ...
 */
public class StTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.be.textbe.st.textst.resource.st.IStHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput infoInput = (org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.be.textbe.st.textst.resource.st.ui.StHyperlink hyperlink = new org.be.textbe.st.textst.resource.st.ui.StHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl iControl = new org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput) {
							org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput input = (org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl.isAvailable(parent)) {
				org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl iControl = new org.be.textbe.st.textst.resource.st.ui.StBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public StTextHover(org.be.textbe.st.textst.resource.st.IStResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.be.textbe.st.textst.resource.st.ui.StUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.insertPageProlog(buffer, 0, org.be.textbe.st.textst.resource.st.ui.StTextHover.getStyleSheet());
			org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.addPageEpilog(buffer);
			return new org.be.textbe.st.textst.resource.st.ui.StDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.be.textbe.st.textst.resource.st.ui.StHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.be.textbe.st.textst.resource.st.ui.StUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.be.textbe.st.textst.resource.st.util.StStreamUtil.getContent(styleSheetURL.openStream());
