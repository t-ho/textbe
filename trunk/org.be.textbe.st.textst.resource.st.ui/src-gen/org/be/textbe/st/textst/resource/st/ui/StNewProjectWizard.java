 ...
 */
public class StNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.be.textbe.st.textst.resource.st.ui");
							...
							String natureID = org.be.textbe.st.textst.resource.st.mopp.StNature.NATURE_ID;
							...
							for (String builderID : org.be.textbe.st.textst.resource.st.mopp.StNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.be.textbe.st.textst.resource.st.mopp.StMetaInformation info = new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation();
