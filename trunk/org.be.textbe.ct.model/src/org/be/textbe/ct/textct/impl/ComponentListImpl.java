 ...
 * <ul>
 *   <li>{@link org.be.textbe.ct.textct.impl.ComponentListImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentListImpl extends EObjectImpl implements ComponentList
{
  ...
  {
		return TextctPackage.Literals.COMPONENT_LIST;
	}
  ...
  {
		if (components == null) {
			components = new EObjectContainmentEList<Component>(Component.class, this, TextctPackage.COMPONENT_LIST__COMPONENTS);
		}
		return components;
	}
  ...
  {
		switch (featureID) {
			case TextctPackage.COMPONENT_LIST__COMPONENTS:
