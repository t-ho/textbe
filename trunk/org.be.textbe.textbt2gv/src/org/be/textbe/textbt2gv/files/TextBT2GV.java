 ...
 *******************************************************************************/
package org.be.textbe.textbt2gv.files;
...
public class TextBT2GV {
	 ...
	 * @generated
	 */
	protected IModel textbtModel;	
	
	/**
	 * The GV model.
	 * @generated
	 */
	protected IModel gvModel;	
	 ...
	 * 
	 * @param textbtModelPath
	 *            the TEXTBT model path
	 * @throws ATLCoreException
	 *             if a problem occurs while loading models
	 *
	 * @generated
	 */
	public void loadModels(String textbtModelPath) throws ATLCoreException {
		ModelFactory factory = new EMFModelFactory();
		IInjector injector = new EMFInjector();
	 	IReferenceModel inMetamodel = factory.newReferenceModel();
		injector.inject(inMetamodel, getMetamodelUri("IN"));
	 	IReferenceModel outMetamodel = factory.newReferenceModel();
		injector.inject(outMetamodel, getMetamodelUri("OUT"));
		this.textbtModel = factory.newModel(inMetamodel);
		injector.inject(textbtModel, textbtModelPath);
		this.gvModel = factory.newModel(outMetamodel);
	}
	 ...
	 * @generated
	 */
	public void saveModels(String gvModelPath) throws ATLCoreException {
		IExtractor extractor = new EMFExtractor();
		extractor.extract(gvModel, gvModelPath);
	}
