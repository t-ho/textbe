...
/**
 * This is the item provider adapter for a {@link org.be.textbe.bttrace.Delay} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BttracePackage.Literals.DELAY__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Integer labelValue = ((Delay)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Delay.class)) {
			case BttracePackage.DELAY__VALUE:
