...
public class StResourceUtil {
	...
	public static org.be.textbe.st.textst.resource.st.mopp.StResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.be.textbe.st.textst.resource.st.mopp.StResource) csResource;
	}
	
	public static org.be.textbe.st.textst.resource.st.mopp.StResource getResource(java.io.File file) {
	...
	public static org.be.textbe.st.textst.resource.st.mopp.StResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.be.textbe.st.textst.resource.st.mopp.StMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.be.textbe.st.textst.resource.st.mopp.StResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.be.textbe.st.textst.TextST getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.be.textbe.st.textst.TextST getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.be.textbe.st.textst.TextST) root;
	}
