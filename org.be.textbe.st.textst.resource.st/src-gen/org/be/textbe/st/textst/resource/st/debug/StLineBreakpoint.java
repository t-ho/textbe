...
public class StLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.be.textbe.st.textst.resource.st.debug.lineBreakpoint.marker";
	
	public StLineBreakpoint() {
		super();
	}
	
	public StLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.be.textbe.st.textst.resource.st.debug.StDebugTarget target) {
		try {
	...
	public void remove(org.be.textbe.st.textst.resource.st.debug.StDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
